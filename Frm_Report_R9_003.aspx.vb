...
Public Class Frm_Report_R9_003
        ...
        If Not IsPostBack Then
            ...
            ElseIf Request.QueryString("id_feeno") <> "" Then
                ...
                If Request.QueryString("copy") <> "" Then
                    ...
                    runpdf(dt, util.root & "Module09\Report_R9_003_V3_01.rdlc", "Fields_Report_R9_003")
                Else
                    If Request.QueryString("rt") <> "" Then
                        dt = getReportData_receipt_fda_in_rt3()
                        runpdf(dt, util.root & "Module09\Report_R9_003_V4_small2.rdlc", "Fields_Report_R9_003")
                    Else
            ...
            ElseIf Request.QueryString("ref01") <> "" Then
                ...
                Else
                    System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "alert('รอการอนุมัติใบเสร็จจากฝ่ายการเงิน');", True)
                End If
    ...
    Public Function getReportData_receipt_fda_in()
        ...
        If dao_re2.fields.FEEABBR = "9005" Or ii > 1 Then
                ...
                If is_law44 = 0 Then
                    ...
                    For Each dr As DataRow In dt2.Rows
                        ...
                        If is_l44 <> 1 Then
                            ...
                            If feeabbr_h = "9005" Or ii > 1 Then
