<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master.Master" CodeBehind="Frm_Print_Receipt_Form_SCB.aspx.vb" Inherits="FDA_FINANCE.Frm_Print_Receipt_Form_SCB" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="panel panel-body"  style="width:100%;"> 
        <h3>พิมพ์ใบเสร็จการชำระเงินผ่านธนาคาร</h3>
    ...
    <table width="100%">
        ...
        <tr>
            <td align="right">
                <asp:Button ID="btn_print" runat="server" Text="พิมพ์รายการที่เลือก" />
            </td>
        </tr>
        <tr>
            <td align="right">
                <telerik:RadGrid ID="RadGrid1" runat="server" AutoGenerateColumns="False" AllowPaging="true" PageSize="50" AllowMultiRowSelection="true" >
                    <MasterTableView>
                        <Columns>
