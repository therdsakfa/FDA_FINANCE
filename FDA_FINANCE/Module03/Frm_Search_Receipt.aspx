<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Search_Receipt.aspx.vb" Inherits="FDA_FINANCE.Frm_Search_Receipt" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table width="100%">
        ...
        <tr>
            <td align="right">
                Ref02</td>
            <td>
                <asp:TextBox ID="txt_ref02" runat="server" CssClass="input-sm" Width="250px"></asp:TextBox></td>
        </tr>
        <tr>
            <td>
                &nbsp;</td>
    ...
    <table width="100%">
        <tr>
            <td>
                <telerik:RadGrid ID="rg_receive" runat="server" AutoGenerateColumns="false" AllowPaging="true" 
