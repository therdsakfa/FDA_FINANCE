<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Maintain_DepositMoney_Debtor_Insert.aspx.vb" Inherits="FDA_FINANCE.Frm_Maintain_DepositMoney_Debtor_Insert" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table>
        ...
        <tr>
            <td align="center">
                <asp:Button ID="btn_Save" runat="server" Text="บันทึก" class="submit" Width="70px"/>
            </td>
        </tr>
    </table>
</asp:Content>
