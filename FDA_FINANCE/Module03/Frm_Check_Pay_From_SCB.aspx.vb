...
Public Class Frm_Check_Pay_From_SCB
    ...
    Private Sub RadGrid1_NeedDataSource(sender As Object, e As Telerik.Web.UI.GridNeedDataSourceEventArgs) Handles RadGrid1.NeedDataSource
        ...
        dt = bao.Get_LOG_PAY_FROM_SCB_NORMAL()
    ...
    Private Sub btn_check_Click(sender As Object, e As EventArgs) Handles btn_check.Click
        ...
        Catch ex As Exception
            Dim dao_re As New DAO_MAS.TB_LOG_RECEIPT_ERROR
            dao_re.fields.CREATEDATE = Date.Now
            dao_re.fields.ERROR_MSG = ex.Message
            dao_re.fields.REF01 = "ตรวจใบเสร็จ"
            dao_re.insert()
            Response.Redirect("http://privus.fda.moph.go.th/", False)
        End Try
        RadGrid1.Rebind()
    ...
    '                    bool = dao.Count_data_by_ref01_ref02(aaa(3), aaa(4))
    '                Else
    '                    bool = dao.Count_data_by_ref01_ref02(aaa(1), aaa(2))
    '                End If
    ...
    '                        .UPLOAD_DATE = Date.Now
    '                        Dim date_text As String = Right(aaa(0), 14)
    '                        Dim date_full As String = ""
    '                        Try
    '                            date_full = Left(date_text, 2) & "/" & Right(Left(date_text, 4), 2) & "/" & (Right(Left(date_text, 8), 4) + 543)
    '                            .DATA_DATE = CDate(date_full)
    ...
    Protected Sub btn_insert_Click(sender As Object, e As EventArgs) Handles btn_insert.Click
        ...
        Dim dt As New DataTable
        Try
            dt = bao.GET_Check_Pay_From_SCB(CDate(txt_date.Text))
        Catch ex As Exception
        ...
        For Each dr As DataRow In dt.Rows
            Try
                ...
                insert_e_bill(dao_fee.fields.dvcd, dao_fee.fields.feeno, dao_fee.fields.feeabbr, False, dr("COL2"), dr("COL3"), "1")
