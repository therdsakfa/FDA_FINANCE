<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Maintain_DepositMoney.aspx.vb" Inherits="FDA_FINANCE.Frm_Maintain_DepositMoney" %>

<%@ Register Src="~/Module03/UseControl/UC_Maintain_DepositMoney.ascx" TagPrefix="uc1" TagName="UC_Maintain_DepositMoney" %>
<%@ Register Src="~/Module03/UseControl/UC_Maintain_DepositMoney_Information.ascx" TagPrefix="uc1" TagName="UC_Maintain_DepositMoney_Information" %>


<%@ Register src="UseControl/UC_Maintain_DepositMoney_SelectDeposit.ascx" tagname="UC_Maintain_DepositMoney_SelectDeposit" tagprefix="uc2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table width="100%">
        ...
        <tr>
            <td colspan="2">
                ...
                <uc1:UC_Maintain_DepositMoney runat="server" ID="UC_Maintain_DepositMoney" />
            </td>
        </tr>
        </table>
        </div>
    <div class="panel panel-body"  style="width:100%;">
        ...
        <tr>
            <td colspan="2">
                <uc2:UC_Maintain_DepositMoney_SelectDeposit ID="UC_Maintain_DepositMoney_SelectDeposit1" runat="server" />
            </td>
        </tr>
    </table>
        </div>
