<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master.Master" CodeBehind="Frm_Maintain_Receive_Money_Auto.aspx.vb" Inherits="FDA_FINANCE.Frm_Maintain_Receive_Money_Auto" %>
            ...
            <tr>
                ...
                <td colspan="3" align="right">
                    <table>
                        <tr>
                            <td>
                                <asp:Button ID="btn_search" runat="server" Text="ค้นหา" style="height: 26px;display:none;"/>
                            </td>
                            <td>
