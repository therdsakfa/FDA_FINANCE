...
Public Class UC_Maintain_ReturnMoney
    ...
    Private Sub rgReturnMoneyDebtor_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles rgReturnMoneyDebtor.Init
        Dim Rad_Utility As New Radgrid_Utility

        Rad_Utility.Rad = rgReturnMoneyDebtor
    ...
    Private Sub rgReceiveMoney_ItemCommand(ByVal source As Object, ByVal e As Telerik.Web.UI.GridCommandEventArgs) Handles rgReturnMoneyDebtor.ItemCommand
        If TypeOf e.Item Is GridDataItem Then
            ...
            ElseIf e.CommandName = "E" Then
                Response.Redirect("Frm_Maintain_ReturnMoney_Debtor_Edit.aspx?DEBTOR_BILL_ID=" & item("RETURN_MONEY_DEBTOR_ID").Text)
            End If
        End If
    End Sub

    Private Sub rgReturnMoney_NeedDataSource(ByVal source As Object, ByVal e As Telerik.Web.UI.GridNeedDataSourceEventArgs) Handles rgReturnMoneyDebtor.NeedDataSource
        Dim bao As New BAO_BUDGET.Maintain
        Dim debtorbillID As String = Request.QueryString("DEBTOR_BILL_ID")
        Dim dt As DataTable = bao.get_RETURN_MONEY_DEBTOR(debtorbillID)
        rgReturnMoneyDebtor.DataSource = dt
    End Sub

    Public Sub bindseq()
        Dim ut_seq As New Radgrid_Utility
        ut_seq.addSeqRG(rgReturnMoneyDebtor)
    End Sub

    Private Sub rgReturnMoney_ItemDataBound(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridItemEventArgs) Handles rgReturnMoneyDebtor.ItemDataBound
