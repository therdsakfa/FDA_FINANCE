Public Class Frm_Maintain_ReturnMoney_Debtor_OutsideBudget_Insert
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            UC_Maintain_ReturnMoney_Detail1.bgyear = Master.get_Year()
            If dt.Rows.Count > 0 Then
                If IsDBNull(dt(0)("MONEYTYPE")) = False Then
                    If dt(0)("MONEYTYPE") = "เงินนอกงบประมาณ" Then
                ...
                End If
            End If
            ' btn_Add.Attributes.Add("onclick", "insert_k('Frm_Maintain_ReturnMoney_Debtor_OutsideBudget_Insert_Detail.aspx?DEBTOR_BILL_ID=" & Request.QueryString("DEBTOR_BILL_ID") & "&maintype=" & rdl_Paytype_main.SelectedValue & " &bgyear=" & Master.get_Year() & "'); return false;")
        End If

    End Sub

    'Private Sub btn_Save_Click(sender As Object, e As EventArgs) Handles btn_Save.Click
    '    Dim dao_maintain_return_money_deptor_outsidebudget As New DAO_MAINTAIN.TB_RETURN_MONEY_DEBTOR
    '    UC_Maintain_ReturnMoney_OutsideBudget_Detail.insert(dao_maintain_return_money_deptor_outsidebudget)
    '    dao_maintain_return_money_deptor_outsidebudget.insert()
