<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Maintain_Receive_Money_V2_Edit.aspx.vb" Inherits="FDA_FINANCE.Frm_Maintain_Receive_Money_V2_Edit" %>
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td colspan="2">
                    ...
                    <asp:DropDownList ID="ddl_receive_type" runat="server" Width="150px">
            ...
            <tr>
                ...
                <td colspan="2">
                    ...
                    <asp:DropDownList ID="ddl_bank" runat="server" DataValueField="BANK_ID" DataTextField="BANK_NAME" Width="150px">
                    ...
                    <table>
                        <tr>
                            <td>
                                &nbsp;</td>
                            <td>
<asp:Button ID="btn_save" runat="server" Text="แก้ไข" />
                            </td>
                        </tr>
                    </table>
