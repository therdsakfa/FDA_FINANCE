<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Check_E_Receipt.aspx.vb" Inherits="FDA_FINANCE.Frm_Check_E_Receipt" %>
            ...
            <td align="center">
                <table width="70%">
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="txt_ref01" runat="server" CssClass="input-sm" Width="150px"></asp:TextBox>
                        </td>
                        <td align="right">
                           เลข Ref02 
                        </td>
                        <td align="left">
                            <asp:TextBox ID="txt_ref02" runat="server" CssClass="input-sm" Width="150px"></asp:TextBox>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td align="right">
                            รหัสผู้ประกอบการ</td>
                        <td align="left">
                            <asp:TextBox ID="txt_lcnsid" runat="server" CssClass="input-sm" Width="150px"></asp:TextBox>
                        </td>
                        <td align="right">
                            &nbsp;</td>
                        <td>
