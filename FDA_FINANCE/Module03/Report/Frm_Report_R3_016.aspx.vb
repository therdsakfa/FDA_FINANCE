Public Class Frm_Report_R3_016
    ...
    Public Function getReportData()
        ...
        Dim dt As DataTable = bao.get_Report_R3_016(UC_Report_SelectDate_Single.dateSelect, dd_BudgetYear.SelectedValue)
    ...
    Private Sub btn_ShowReport_Click(sender As Object, e As EventArgs) Handles btn_ShowReport.Click
        ...
        util.ShowReport(ReportViewer1, util.root & "Module03\Report_R3_016.rdlc", "Fields_Report_R3_016", getReportData())
    End Sub
End Class