<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Report_R3_016_2.aspx.vb" Inherits="FDA_FINANCE.Frm_Report_R3_016_2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table>
        <tr>
            <td>บัญชีย่อยเงินรายได้แผ่นดิน</td>
        </tr>
        <tr>
            <td>
                <table>
