Public Class Frm_Report_R3_004
    ...
    Public Function getReportData()
        ...
        Dim dt As DataTable = bao.getReportData_R3_004(UC_Report_SelectDate_Between.dateBegin, UC_Report_SelectDate_Between.dateEnd) 'ส่ง Parameter วันที่ต้องการดูรายงานเข้าไป
    ...
    Private Sub btn_ShowReport_Click(sender As Object, e As EventArgs) Handles btn_ShowReport.Click
        ...
        util.ShowReport(ReportViewer1, util.root & "Module03\Report_R3_004.rdlc", "Fields_Report_R3_004", getReportData())
    End Sub
End Class