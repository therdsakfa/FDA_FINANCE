<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Report_R3_001.aspx.vb" Inherits="FDA_FINANCE.Frm_Report_R3_001" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table>
        <tr>
            <td>รายงานสรุปนำเงินฝากธนาคาร ณ สิ้นวัน</td>
        </tr>
        <tr>
            <td>
