Public Class Frm_Report_R3_007
    ...
    Public Function getReportData()
        ...
        Dim dt As DataTable = bao.getReportData_R3_007(rdp_dateReportSelect.SelectedDate)
    ...
    Private Sub btn_ShowReport_Click(sender As Object, e As EventArgs) Handles btn_ShowReport.Click
        ...
        util.ShowReport(ReportViewer1, util.root & "Module03\Report_R3_007.rdlc", "Fields_Report_R3_007", getReportData())
    End Sub
End Class