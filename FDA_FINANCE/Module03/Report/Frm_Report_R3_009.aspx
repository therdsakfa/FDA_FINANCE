<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Report_R3_009.aspx.vb" Inherits="FDA_FINANCE.Frm_Report_R3_009" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table>
        <tr>
            <td>รายงานสรุปเงินสดและรายการเทียบเท่าเงินสดคงเหลือ ณ วันที่</td>
        </tr>
        <tr>
            <td>
                ...
                <asp:Button ID="btn_ShowReport_2" runat="server" Text="ดูรายงานเงินสดคงเหลือ" />
            </td>
        </tr>
        <tr>
            <td>
