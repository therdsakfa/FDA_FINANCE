<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Report_R3_015_3.aspx.vb" Inherits="FDA_FINANCE.Frm_Report_R3_015_3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table>
        <tr>
            <td>รายงานเปรียบเทียบข้อมูลการรับเงินจากธนาคารกับข้อมูลการสั่งชำระ</td>
        </tr>
        <tr>
            <td>
                <table>
