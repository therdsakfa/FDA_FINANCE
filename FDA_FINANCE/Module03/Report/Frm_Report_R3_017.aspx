<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Report_R3_017.aspx.vb" Inherits="FDA_FINANCE.Frm_Report_R3_017" %>
            ...
            <td>
                <table>
                    <tr>
                       ...
                       <td>ผู้รับเงิน :</td>
                        <td>
                            <asp:DropDownList ID="ddl_receiver" runat="server" Width="90px"></asp:DropDownList>
                        </td>
                        <td>
