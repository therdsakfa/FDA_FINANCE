<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Maintain_Other_Pay_Edit.aspx.vb" Inherits="FDA_FINANCE.Frm_Maintain_Other_Pay_Edit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <asp:Panel ID="Panel1" runat="server" GroupingText="แก้ไขรับ/จ่ายเงินอื่นๆ">
    <table>
    <tr>
            <td>
        ...
        <tr>
        <td align="center">
        <asp:Button ID="btn_bill_save" runat="server" Text="แก้ไข" Width="60px" />
        </td>
