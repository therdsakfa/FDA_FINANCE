<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Maintain_ReturnMoney_Debtor_Edit_Detail.aspx.vb" Inherits="FDA_FINANCE.Frm_Maintain_ReturnMoney_Debtor_Edit_Detail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table>
         <tr>
            <td>แก้ไขข้อมูลการคืนเงิน ลูกหนี้เงินยืม</td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td align="center">
                <asp:Button ID="btn_Save" runat="server" Text="แก้ไข" class="submit"/>
