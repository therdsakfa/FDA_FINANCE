<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Maintain_ReturnMoney_Debtor_OutsideBudget_Insert_Detail.aspx.vb" Inherits="FDA_FINANCE.Frm_Maintain_ReturnMoney_Debtor_OutsideBudget_Insert_Detail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table>
         <tr>
            <td>เพิ่มข้อมูลการคืนเงิน ลูกหนี้เงินยืมนอกงบ</td>
        </tr>
        <tr>
            <td>
