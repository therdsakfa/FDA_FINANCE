<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Maintain_ReceiveMoney_Receipt_Search_Informix.aspx.vb" Inherits="FDA_FINANCE.Frm_Maintain_ReceiveMoney_Receipt_Search_Informix" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="panel panel-body" style="width: 100%;">
        <h3>ค้นหาใบสั่งชำระ (ระบบเก่า)</h3>
