<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node_E.Master" CodeBehind="Frm_Check_Pay_From_SCB_L44.aspx.vb" Inherits="FDA_FINANCE.Frm_Check_Pay_From_SCB_L44" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="panel panel-body"  style="width:100%;"> 
        <h3>รายการตรวจสอบการชำระเงินผ่านธนาคาร (ม.44)</h3>
