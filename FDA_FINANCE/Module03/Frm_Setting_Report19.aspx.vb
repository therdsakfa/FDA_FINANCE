...
Public Class Frm_Setting_Report19
    ...
    Private Sub rg_sending_ItemDataBound(sender As Object, e As Telerik.Web.UI.GridItemEventArgs) Handles rg_sending.ItemDataBound
        If e.Item.ItemType = GridItemType.AlternatingItem Or e.Item.ItemType = GridItemType.Item Then
            ...
            edt.Attributes.Add("OnClick", "Popups('Frm_Setting_Report19_Insert.aspx?ida=" & id & "&myear=" & dao.fields.BUDGET_YEAR & "'); return false;")

            Dim url As String = "../Module03/Report/Frm_Report_R3_019.aspx?ida=" & id
    ...
    Private Sub rg_sending_NeedDataSource(sender As Object, e As Telerik.Web.UI.GridNeedDataSourceEventArgs) Handles rg_sending.NeedDataSource
        ...
        If Request.QueryString("law") <> "" Then
            Try
                dt = bao.get_Data_Send_money_by_Budget_Year_L44(dd_BudgetYear.SelectedValue)
            Catch ex As Exception

            End Try
        Else
            Try
                dt = bao.get_Data_Send_money_by_Budget_Year(dd_BudgetYear.SelectedValue)
            Catch ex As Exception
