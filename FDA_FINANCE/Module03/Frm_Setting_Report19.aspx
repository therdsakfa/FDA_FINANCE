<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node2.Master" CodeBehind="Frm_Setting_Report19.aspx.vb" Inherits="FDA_FINANCE.Frm_Setting_Report19" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#ctl00_ContentPlaceHolder1_btn_add').click(function () {
                ...
                var law = getQuerystring('law');
                if (law != '') {
                    Popups('Frm_Setting_Report19_Insert.aspx?myear=' + bgYear.toString() + '&law=' +law);
                } else {
                    Popups('Frm_Setting_Report19_Insert.aspx?myear=' + bgYear.toString());
                }
