<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Maintain_ReturnMoney_Debtor_OutsideBudget.aspx.vb" Inherits="FDA_FINANCE.Frm_Maintain_ReturnMoney_Debtor_OutsideBudget" %>
...
<%@ Register src="UseControl/UC_Maintain_ReturnMoney_OutsideBudget_Debtor.ascx" tagname="UC_Maintain_ReturnMoney_OutsideBudget_Debtor" tagprefix="uc3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="panel panel-body"  style="width:100%;"> 
        <h3>รายการบันทึกการรับเงินรับคืนเงินลูกหนี้เงินนอกงบประมาณ</h3>
    ...
    <table width="100%">
        ...
        <tr>
            <td colspan="2">
                ...
                <uc3:UC_Maintain_ReturnMoney_OutsideBudget_Debtor ID="UC_Maintain_ReturnMoney_OutsideBudget_Debtor1" runat="server" />
            </td>
        </tr>
    </table>
        </div>
