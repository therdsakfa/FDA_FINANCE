Public Class Frm_Report_R5_001
    ...
    Public Function getReportData()
        ...
        UC_MoneyType_Head1.getDateSelect()
        Dim head_id As Integer = UC_MoneyType_Head1.money_id
        ...
        For Each drhead As DataRow In dt_head.Rows
            ...
            Dim dt As DataTable = bao.getReportData_R5_001(UC_Report_SelectDate_Between.dateBegin, UC_Report_SelectDate_Between.dateEnd, drhead("MONEY_TYPE_ID"), dd_BudgetYear.SelectedValue) 'ส่ง Parameter วันที่ต้องการดูรายงานเข้าไป
        ...
        'Dim dv As DataView = dt_merge.DefaultView
        'dv.Sort = "bill_date ASC"
        'dt_merge = dv.ToTable
    ...
    Public Function get_old_val(ByRef dt_merge As DataTable, ByVal head_id As Integer) As DataTable
        ...
        For Each drhead As DataRow In dt_head.Rows
            ...
            old_val = old_val + bao_old_balancec.get_old_balance_no_app(drhead("MONEY_TYPE_ID"), dd_BudgetYear.SelectedValue)
        ...
        'dao.Getdata_by_MONEY_TYPE_ID(drhead("MONEY_TYPE_ID"))


        'If dao.fields.MONEY_AMOUNT IsNot Nothing Or dao.fields.MONEY_AMOUNT <> 0 Then
        'Dim dao_mnt As New DAO_MAS.TB_MAS_MONEY_TYPE
        'dao_mnt.Getdata_by_MONEY_TYPE_ID(dao.fields.MONEY_TYPE_ID)

        'Dim dao_mnt_head As New DAO_MAS.TB_MAS_MONEY_TYPE
        'If dao_mnt.fields.MONEY_TYPE_ID <> Nothing Then
        '    'dao_mnt_head.Getdata_Head_non_year(dao_mnt.fields.HEAD_MONEY_TYPE_ID)
        '    dao_mnt_head.Getdata_by_MONEY_TYPE_ID(dao_mnt.fields.HEAD_MONEY_TYPE_ID)
        'End If
        ...
        dr_m("parammoneytype") = "" 'dao_mnt_head.fields.MONEY_TYPE_DESCRIPTION
        dr_m("parammoneysubtype") = "" 'dao_mnt.fields.MONEY_TYPE_DESCRIPTION
        dr_m("BUDGET_YEAR") = DBNull.Value
        dr_m("po") = 0
        dr_m("no_po") = 0
        dr_m("paramdatebegin") = strDateBegin
        dr_m("paramdateend") = strDateEnd
        dr_m("checknumber") = ""
        dr_m("CUSTOMER_NAME") = ""
        'dr_m("balance") = old_val
    ...
    '    Dim strDateBegin As String = bao_date.convertDateToString(UC_Report_SelectDate_Between.dateBegin)
    '    Dim strDateEnd As String = bao_date.convertDateToString(UC_Report_SelectDate_Between.dateEnd)
    '    Dim dt As DataTable = bao.getReportData_R5_001(UC_Report_SelectDate_Between.dateBegin, UC_Report_SelectDate_Between.dateEnd, id, dd_BudgetYear.SelectedValue) 'ส่ง Parameter วันที่ต้องการดูรายงานเข้าไป
    '    dt.Columns.Add("money_type_des")
    '    For Each dr As DataRow In dt.Rows
    ...
    '    Dim bao_old_balancec As New BAO_BUDGET.DISBURSE_BUDGET
    '    Dim old_val As Double = 0.0
    '    old_val = bao_old_balancec.get_old_balance_no_app(id, dd_BudgetYear.SelectedValue)
    '    If dao.fields.MONEY_AMOUNT IsNot Nothing Or dao.fields.MONEY_AMOUNT <> 0 Then
    '        Dim dao_mnt As New DAO_MAS.TB_MAS_MONEY_TYPE
    '        dao_mnt.Getdata_by_MONEY_TYPE_ID(dao.fields.MONEY_TYPE_ID)
    ...
    '        dr_m("payburse") = 0
    '        dr_m("payborrow") = 0
    '        dr_m("MONEY_TYPE_ID") = dao.fields.MONEY_TYPE_ID
    '        dr_m("pay") = 0
    '        dr_m("description") = "ยอดยกมา :"
    '        dr_m("balance") = 0
    '        dr_m("approve") = DBNull.Value
