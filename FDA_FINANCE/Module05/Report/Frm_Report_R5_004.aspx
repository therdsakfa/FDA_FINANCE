<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Report_R5_004.aspx.vb" Inherits="FDA_FINANCE.Frm_Report_R5_004" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table>
        <tr>
            <td>รายงานสรุปรายรับและฝาก(รง.4)</td>
        </tr>
        <tr>
            <td>
