Public Class Frm_Report_R5_009
    ...
    Public Function getReportData()
        ...
        Dim dt As DataTable = bao.getReportData_R5_009(rdp_dateReportSelect.SelectedDate)
    ...
    Private Sub btn_ShowReport_Click(sender As Object, e As EventArgs) Handles btn_ShowReport.Click
        ...
        util.ShowReport(ReportViewer1, util.root & "Module05\Report_R5_009.rdlc", "Fields_Report_R5_009", getReportData())
    End Sub
End Class