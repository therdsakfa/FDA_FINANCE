Public Class Frm_Report_R5_007
    ...
    Public Function getReportData()
        ...
        Dim dt As DataTable = bao.getReportData_R5_007()
        Return dt
    End Function
    ...
    Private Sub btn_ShowReport_Click(sender As Object, e As EventArgs) Handles btn_ShowReport.Click
        ...
        util.ShowReport(ReportViewer1, util.root & "Module05\Report_R5_007.rdlc", "Fields_Report_R5_007", getReportData())
    End Sub
End Class