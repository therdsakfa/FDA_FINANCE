<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Disburse_OutsideDebtor_Check_Pay.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_OutsideDebtor_Check_Pay" %>
...
<%@ Register src="~/Module02/Disburse_Debtor/UserControl/UC_Disburse_Debtor_Check_Pay.ascx" tagname="UC_Disburse_Debtor_Check_Pay" tagprefix="uc2" %>
            ...
            <table width="100%">
                ...
                <tr>
                    <td>
                        ...
                        <uc2:UC_Disburse_Debtor_Check_Pay ID="UC_Disburse_Debtor_Check_Pay1" runat="server" />
