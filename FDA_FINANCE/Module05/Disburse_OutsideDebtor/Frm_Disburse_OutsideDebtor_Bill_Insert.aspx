<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Disburse_OutsideDebtor_Bill_Insert.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_OutsideDebtor_Bill_Insert" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
        ...
        <tr>
        <td>
        <asp:Button ID="btn_bill_save" runat="server" Text="บันทึกใบเบิกจ่าย" />
        </td>
