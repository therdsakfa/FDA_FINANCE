<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Disburse_OutsideDebtor_Boss_Approve.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_OutsideDebtor_Boss_Approve" %>
<%@ Register assembly="Telerik.Web.UI" namespace="Telerik.Web.UI" tagprefix="telerik" %>
<%@ Register src="~/Module02/Disburse_Debtor/UserControl/UC_Disburse_Debtor_Boss_Approve.ascx" tagname="UC_Disburse_Debtor_Boss_Approve" tagprefix="uc1" %>
    ...
    <div class="panel panel-body"  style="width:100%;padding-left:5%;">
          ...
          <%--          <asp:Button ID="btn_download" runat="server" CssClass="btn-lg " Text="ดาวน์โหลดคำขอ" Width="170px" />
            ...
            <tr><td colspan="3">
                ...
                <uc1:UC_Disburse_Debtor_Boss_Approve ID="UC_Disburse_Debtor_Boss_Approve1" runat="server" />
