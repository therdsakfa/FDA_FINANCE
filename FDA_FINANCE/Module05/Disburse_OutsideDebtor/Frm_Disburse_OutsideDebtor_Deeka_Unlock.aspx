<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Disburse_OutsideDebtor_Deeka_Unlock.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_OutsideDebtor_Deeka_Unlock" %>

<%@ Register src="../../UC/UC_Project_Information.ascx" tagname="UC_Project_Information" tagprefix="uc4" %>
<%@ Register assembly="Telerik.Web.UI" namespace="Telerik.Web.UI" tagprefix="telerik" %>
<%@ Register src="../../Module02/Disburse_Budget/UserControl/UC_Search_Form.ascx" tagname="UC_Search_Form" tagprefix="uc5" %>
<%@ Register src="../../Module02/Disburse_Debtor/UserControl/UC_Disburse_Debtor_Unlock_Deeka.ascx" tagname="UC_Disburse_Debtor_Unlock_Deeka" tagprefix="uc6" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-body"  style="width:100%;">
        <table><tr> <td> 
            <uc5:UC_Search_Form ID="UC_Search_Form1" runat="server" />
            </td>
        <td valign="middle">
...
<div class="panel panel-body"  style="width:100%;">
            ...
            <tr><td colspan="2">
                <uc6:UC_Disburse_Debtor_Unlock_Deeka ID="UC_Disburse_Debtor_Unlock_Deeka1" runat="server" />
                </td></tr>
