<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UC_Disburse_OutsideDebtor_Approve_Ok.ascx.vb" Inherits="FDA_FINANCE.UC_Disburse_OutsideDebtor_Approve_Ok" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<telerik:RadScriptManager ID="RadScriptManager1" runat="server">
</telerik:RadScriptManager>
<telerik:RadGrid ID="rgAppOK" runat="server" GridLines="None" 
...
<%--<MasterTableView >
    <Columns>
        ...
        <telerik:GridBoundColumn HeaderText="อนุมัติ" >
