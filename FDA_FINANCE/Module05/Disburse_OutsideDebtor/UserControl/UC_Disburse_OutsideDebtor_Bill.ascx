<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UC_Disburse_OutsideDebtor_Bill.ascx.vb" Inherits="FDA_FINANCE.UC_Disburse_OutsideDebtor_Bill" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<telerik:RadScriptManager ID="RadScriptManager1" runat="server">
</telerik:RadScriptManager>
<telerik:RadGrid ID="rgAddKNumber" runat="server" GridLines="None" 
...
<%--<MasterTableView >
    <Columns>
        ...
        <telerik:GridBoundColumn HeaderText="เลข ขบ." >
        
        </telerik:GridBoundColumn>
        <telerik:GridBoundColumn HeaderText="วันที่บันทึกเลข ขบ." >
