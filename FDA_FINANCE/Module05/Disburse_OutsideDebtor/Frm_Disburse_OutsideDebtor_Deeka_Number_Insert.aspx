<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Disburse_OutsideDebtor_Deeka_Number_Insert.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_OutsideDebtor_Deeka_Number_Insert" %>
<%@ Register src="../../Module02/Disburse_Debtor/UserControl/UC_Disburse_Debtor_Deeka_Number_Detail.ascx" tagname="UC_Disburse_Debtor_Deeka_Number_Detail" tagprefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
            <td>
                ...
                <uc1:UC_Disburse_Debtor_Deeka_Number_Detail ID="UC_Disburse_Debtor_Deeka_Number_Detail1" runat="server" />
