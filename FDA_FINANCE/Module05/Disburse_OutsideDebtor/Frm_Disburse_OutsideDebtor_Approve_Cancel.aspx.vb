...
Public Class Frm_Disburse_OutsideDebtor_Approve_Cancel
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        UC_Disburse_Debtor_Approve_Cancel1.bg_use = 3
        UC_Disburse_Debtor_Approve_Cancel1.bg_year = bgYear
        UC_Disburse_Debtor_Approve_Cancel1.dept = _dept
        ...
        End If
        'Try
        'UC_Disburse_Debtor_Approve_Cancel1.BudgetID = rcb_Moneytype.SelectedValue
        'UC_OutsideBudget_Amount_Detail1.getBGOutside_detail(rcb_Moneytype.SelectedValue, bgYear)


        ' UC_Disburse_Debtor_Approve_Cancel1.dept = dd_Department.SelectedValue()
        UC_OutsideBudget_Amount_Detail1.Budgetyear = bgYear
        If rcb_Moneytype.SelectedValue = "" Then
            UC_Disburse_Debtor_Approve_Cancel1.BudgetID = 0
    ...
    Private Sub btnSearch_Click(sender As Object, e As EventArgs) Handles btnSearch.Click
        ...
        UC_Disburse_Debtor_Approve_Cancel1.rgFilter(str)
    End Sub

    'Private Sub dd_BudgetAdjust_TextChanged(sender As Object, e As EventArgs) Handles dd_BudgetAdjust.TextChanged
    '    UC_Disburse_Debtor_Approve_Cancel1.rg_rebind()
    'End Sub

    Private Sub Page_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        
        UC_Disburse_Debtor_Approve_Cancel1.bindseq()
    End Sub
    ...
    Private Sub rcb_Moneytype_SelectedIndexChanged(sender As Object, e As RadComboBoxSelectedIndexChangedEventArgs) Handles rcb_Moneytype.SelectedIndexChanged
        UC_Disburse_Debtor_Approve_Cancel1.rg_rebind()
    End Sub
