<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Disburse_OutsideDebtor_Check_Number_Sign.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_OutsideDebtor_Check_Number_Sign" %>
...
<%@ Register src="~/Module02/Disburse_Debtor/UserControl/UC_Disburse_Debtor_Check_Sign.ascx" tagname="UC_Disburse_Debtor_Check_Sign" tagprefix="uc1" %>
            ...
            <table width="100%">
                ...
                <tr>
                    <td>
                        ...
                        <uc1:UC_Disburse_Debtor_Check_Sign ID="UC_Disburse_Debtor_Check_Sign1" runat="server" />
