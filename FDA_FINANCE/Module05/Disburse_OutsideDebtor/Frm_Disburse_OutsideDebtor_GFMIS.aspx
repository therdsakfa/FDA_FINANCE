<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Disburse_OutsideDebtor_GFMIS.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_OutsideDebtor_GFMIS" %>
<%@ Register src="../../Module02/Disburse_Budget/UserControl/UC_Search_Form.ascx" tagname="UC_Search_Form" tagprefix="uc3" %>
<%@ Register src="../../Module02/Disburse_Debtor/UserControl/UC_Disburse_Debtor_Bill.ascx" tagname="UC_Disburse_Debtor_Bill" tagprefix="uc4" %>
...
<table width="100%">
        <tr>
            <td>
                ...
                <uc4:UC_Disburse_Debtor_Bill ID="UC_Disburse_Debtor_Bill1" runat="server" />
