Public Class Frm_Disburse_OutsideDebtor_Check_Number_Ready
    ...
    Public Sub set_uc()
        ...
        UC_Disburse_Debtor_Check_Ready1.bg_use = 3
        UC_Disburse_Debtor_Check_Ready1.bgyear = Request.QueryString("myear")
        UC_Disburse_Debtor_Check_Ready1.bt = 3
        UC_Disburse_Debtor_Check_Ready1.stat = 8
        UC_Disburse_Debtor_Check_Ready1.g = 7
        UC_Disburse_Debtor_Check_Ready1.debtor_type = 2
    End Sub
