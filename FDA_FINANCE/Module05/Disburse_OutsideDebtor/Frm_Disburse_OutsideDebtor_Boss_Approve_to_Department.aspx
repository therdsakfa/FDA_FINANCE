<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Disburse_OutsideDebtor_Boss_Approve_to_Department.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_OutsideDebtor_Boss_Approve_to_Department1" %>
<%@ Register assembly="Telerik.Web.UI" namespace="Telerik.Web.UI" tagprefix="telerik" %>

<%@ Register src="~/Module02/Disburse_Debtor/UserControl/UC_Disburse_Debtor_Boss_Accept_to_Department.ascx" tagname="UC_Disburse_Debtor_Boss_Accept_to_Department" tagprefix="uc1" %>
