Public Class Frm_Disburse_Outside_Budget_Transfer
    ...
    End Sub
    Public Sub set_uc()
        UC_Disburse_Budget_Transfer_to_Customer1.BudgetUseID = 3
        ...
        UC_Disburse_Budget_Transfer_to_Customer1.stat = 10
