Public Class Frm_Disburse_OutsideBudget_PayType_Pass_Check_Pay
    ...
    Public Sub set_uc()
        ...
        UC_Disburse_Budget_PayType_Pass_Check_Pay1.bg_use = 3
        ...
        UC_Disburse_Budget_PayType_Pass_Check_Pay1.g = 6
    End Sub
