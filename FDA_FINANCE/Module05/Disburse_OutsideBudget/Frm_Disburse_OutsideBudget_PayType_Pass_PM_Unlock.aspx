<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Disburse_OutsideBudget_PayType_Pass_PM_Unlock.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_OutsideBudget_PayType_Pass_PM_Unlock" %>
<%@ Register src="~/Module02/Disburse_Budget/UserControl/UC_Search_Form.ascx" tagname="UC_Search_Form" tagprefix="uc3" %>
<%@ Register src="~/Module02/Disburse_Budget/UserControl/UC_Disburse_Budget_PayType_Pass_Pay_Unlock.ascx" tagname="UC_Disburse_Budget_PayType_Pass_Pay_Unlock" tagprefix="uc1" %>
...
<table width="100%">
        <tr>
            <td >
                ...
                <uc1:UC_Disburse_Budget_PayType_Pass_Pay_Unlock ID="UC_Disburse_Budget_PayType_Pass_Pay_Unlock1" runat="server" />
