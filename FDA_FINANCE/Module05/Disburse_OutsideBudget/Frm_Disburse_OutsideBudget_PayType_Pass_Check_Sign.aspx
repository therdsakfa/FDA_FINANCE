<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Disburse_OutsideBudget_PayType_Pass_Check_Sign.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_OutsideBudget_PayType_Pass_Check_Sign" %>
...
<%@ Register src="~/Module02/Disburse_Budget/UserControl/UC_Disburse_Budget_PayType_Pass_Check_Sign.ascx" tagname="UC_Disburse_Budget_PayType_Pass_Check_Sign" tagprefix="uc1" %>
            ...
            <table width="100%">
                <tr>
                    <td align="right">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="btn_approve" runat="server" CssClass="btn-lg" Text="เสนอแล้ว" />
                            </td>
                        </tr>
                    </table>
                    </td>
                ...
                <tr>
                    <td>
                        ...
                        <uc1:UC_Disburse_Budget_PayType_Pass_Check_Sign ID="UC_Disburse_Budget_PayType_Pass_Check_Sign1" runat="server" />
