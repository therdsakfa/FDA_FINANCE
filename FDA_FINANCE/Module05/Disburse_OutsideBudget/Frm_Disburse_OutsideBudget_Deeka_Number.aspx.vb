Public Class Frm_Disburse_OutsideBudget_Deeka_Number
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        UC_Disburse_Budget_Deeka_Number1.BudgetUseID = 3
        UC_Disburse_Budget_Deeka_Number1.PAY_TYPE_ID = 2
    ...
    Private Sub Page_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        UC_Disburse_Budget_Deeka_Number1.bindseq()
    End Sub
