<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Disburse_OutsideBudget_Overview.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_OutsideBudget_Overview" %>
...
<%@ Register src="~/Module02/Disburse_Budget/UserControl/UC_Disburse_Budget_With_Approve.ascx" tagname="UC_Disburse_Budget_With_Approve" tagprefix="uc4" %>
        ...
        $(document).ready(function () {
            ...
            $('#ctl00_ContentPlaceHolder1_btn_Add').click(function () {
                ...
                //if (selectVal != '') {
                    ...
                    Popups('../../Module02/Disburse_Budget/Frm_Disburse_Budget_Bill_Insert_V2.aspx?bgid=' + selectVal.toString() + '&bgYear=' + bgYear.toString() + '&dept=' + select_dept.toString() + '&bguse=3');
                    //Popups('Frm_Disburse_OutsideBudget_Bill_Insert.aspx?bgid=' + selectVal + '&bgYear=' + bgYear.toString() + '&dept=' + select_dept.toString() + '&bguse=3');
...
<tr>
    <td colspan="2">
        หน่วยงาน &nbsp;<asp:DropDownList ID="dd_Department" runat="server" DataTextField="DEPARTMENT_DESCRIPTION" DataValueField="DEPARTMENT_ID" AutoPostBack="true" Font-Size="Small">
