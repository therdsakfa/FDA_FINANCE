<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Disburse_Outside_Budget_Receive_List.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_Outside_Budget_Receive_List" %>

<%@ Register src="../../Module02/Disburse_Budget/UserControl/UC_Disburse_Budget_Receive_List.ascx" tagname="UC_Disburse_Budget_Receive_List" tagprefix="uc1" %>
<%@ Register src="../../Module02/Disburse_Budget/UserControl/UC_Search_Form_Receive_List.ascx" tagname="UC_Search_Form_Receive_List" tagprefix="uc2" %>
