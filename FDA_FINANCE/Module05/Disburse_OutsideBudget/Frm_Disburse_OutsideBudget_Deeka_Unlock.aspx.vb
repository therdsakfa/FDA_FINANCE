Public Class Frm_Disburse_OutsideBudget_Deeka_Unlock
    ...
    Public Sub set_uc()
        Try
            ...
            UC_Disburse_Budget_Deeka_Unlock1.BudgetUseID = 3
            UC_Disburse_Budget_Deeka_Unlock1.g = 0
            UC_Disburse_Budget_Deeka_Unlock1.stat = 8

            UC_OutsideBudget_Amount_Detail1.BudgetplanId = _bgid
            UC_OutsideBudget_Amount_Detail1.dept = _dept
            UC_OutsideBudget_Amount_Detail1.Budgetyear = Request.QueryString("myear")
            UC_OutsideBudget_Amount_Detail1.getBGOutside_detail(_bgid, Request.QueryString("myear"))
