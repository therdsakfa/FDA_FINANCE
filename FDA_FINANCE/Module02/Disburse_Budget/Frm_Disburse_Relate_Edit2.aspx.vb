Public Class Frm_Disburse_Relate_Edit2
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            UC_RELATE_BILL_DETAIL21.bind_dd_cus()
            UC_RELATE_BILL_DETAIL21.bind_dd_gl()
            If Request.QueryString("bid") IsNot Nothing Then
                ...
                UC_RELATE_BILL_DETAIL21.get_data(dao)
    ...
    Private Sub btn_bill_save_Click(sender As Object, e As EventArgs) Handles btn_bill_save.Click
        If Request.QueryString("bid") IsNot Nothing Then
            Dim dao As New DAO_DISBURSE.TB_RELATE_BG_ALL
            dao.Getdata_by_ID(Request.QueryString("bid"))
            UC_RELATE_BILL_DETAIL21.set_data(dao)
            Try
                dao.fields.AD_EDIT = NameUserAD()
            Catch ex As Exception

            End Try
            dao.fields.EDIT_DATE = Date.Now
            dao.update()
    ...
    Private Sub btn_confirm_Click(sender As Object, e As EventArgs) Handles btn_confirm.Click
        UC_RELATE_BILL_DETAIL21.set_panel_confirm()
    ...
    Private Sub btn_cancel_Click(sender As Object, e As EventArgs) Handles btn_cancel.Click
        UC_RELATE_BILL_DETAIL21.set_panel_cancel()
