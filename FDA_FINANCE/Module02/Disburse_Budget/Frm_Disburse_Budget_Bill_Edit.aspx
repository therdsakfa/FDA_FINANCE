<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Disburse_Budget_Bill_Edit.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_Budget_Bill_Edit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('#<%= btn_bill_edit.ClientID%>').click(function () {
    ...
    <tr>
        ...
        <tr>
        <td>
        <asp:Button ID="btn_bill_edit" runat="server" Text="แก้ไขใบเบิกจ่าย" />
        </td>
