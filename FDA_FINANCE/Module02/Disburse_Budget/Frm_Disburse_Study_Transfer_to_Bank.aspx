<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Disburse_Study_Transfer_to_Bank.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_Study_Transfer_to_Bank" %>
<%@ Register assembly="Telerik.Web.UI" namespace="Telerik.Web.UI" tagprefix="telerik" %>
<%@ Register src="UserControl/UC_Search_Form.ascx" tagname="UC_Search_Form" tagprefix="uc1" %>
<%@ Register src="UserControl/UC_Disburse_Cure_Study_Transfer_to_Bank.ascx" tagname="UC_Disburse_Cure_Study_Transfer_to_Bank" tagprefix="uc2" %>
...
<DatePopupButton ImageUrl="" HoverImageUrl=""></DatePopupButton>
            ...
            <tr><td colspan="3">
                ...
                <uc2:UC_Disburse_Cure_Study_Transfer_to_Bank ID="UC_Disburse_Cure_Study_Transfer_to_Bank1" runat="server" />
