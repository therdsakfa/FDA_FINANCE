<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Disburse_Cure_KNumber.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_Cure_KNumber" %>
<%@ Register src="UserControl/UC_Disburse_Cure_GF.ascx" tagname="UC_Disburse_Cure_GF" tagprefix="uc1" %>
<%@ Register src="UserControl/UC_Search_From_Cure_Study.ascx" tagname="UC_Search_From_Cure_Study" tagprefix="uc2" %>
...
<table width="100%">
        <tr>
            <td>
                ...
                <uc1:UC_Disburse_Cure_GF ID="UC_Disburse_Cure_GF1" runat="server" />
