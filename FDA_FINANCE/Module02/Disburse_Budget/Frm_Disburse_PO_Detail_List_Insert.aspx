<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Disburse_PO_Detail_List_Insert.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_PO_Detail_List_Insert" %>

<%@ Register src="UserControl/UC_Disburse_Budget_DetailV2.ascx" tagname="UC_Disburse_Budget_DetailV2" tagprefix="uc1" %>
<%@ Register src="UserControl/UC_Disburse_PO_Detail_Table.ascx" tagname="UC_Disburse_PO_Detail_Table" tagprefix="uc2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
            <td>
                ...
                <uc2:UC_Disburse_PO_Detail_Table ID="UC_Disburse_PO_Detail_Table1" runat="server" />
            </td>
        </tr>
        <tr>
        <td align="center">
