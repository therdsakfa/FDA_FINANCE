<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Disburse_Study_Pay_Unlock.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_Study_Pay_Unlock" %>
<%@ Register src="UserControl/UC_Search_Form.ascx" tagname="UC_Search_Form" tagprefix="uc3" %>

<%@ Register src="UserControl/UC_Disburse_Cure_Study_Pay_Unlock.ascx" tagname="UC_Disburse_Cure_Study_Pay_Unlock" tagprefix="uc1" %>
...
<table width="100%">
        <tr>
            <td >
                ...
                <uc1:UC_Disburse_Cure_Study_Pay_Unlock ID="UC_Disburse_Cure_Study_Pay_Unlock1" runat="server" />
