<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Disburse_Relate_Insert2.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_Relate_Insert2" %>

<%@ Register src="UserControl/UC_RELATE_BILL_DETAIL2.ascx" tagname="UC_RELATE_BILL_DETAIL2" tagprefix="uc1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            showdate($("#ctl00_ContentPlaceHolder1_UC_RELATE_BILL_DETAIL21_txt_dodate"));
            ...
            showdate($("#ctl00_ContentPlaceHolder1_UC_RELATE_BILL_DETAIL21_txt_DOC_DATE"));

            $("#ctl00_ContentPlaceHolder1_UC_RELATE_BILL_DETAIL21_dd_CUSTOMER").searchable();
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
            <td>
                ...
                <uc1:UC_RELATE_BILL_DETAIL2 ID="UC_RELATE_BILL_DETAIL21" runat="server" />
