<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Disburse_PO_Sub_List.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_PO_Sub_List" %>
<%@ Register assembly="Telerik.Web.UI" namespace="Telerik.Web.UI" tagprefix="telerik" %>
<%@ Register src="UserControl/UC_Search_Form.ascx" tagname="UC_Search_Form" tagprefix="uc3" %>
<%@ Register src="UserControl/UC_PO_Sub_List.ascx" tagname="UC_PO_Sub_List" tagprefix="uc1" %>
...
<%--      <link href="../../Scripts/jquery-ui.css" rel="stylesheet" type="text/css" />
  ...
  <div class="panel panel-body"  style="width:100%;">
       <h3>รายการจัดซื้อจัดจ้าง (งวด)</h3>
       </div> 
     ...
     <tr>
        ...
        <tr>
            <td >
                ...
                <uc1:UC_PO_Sub_List ID="UC_PO_Sub_List1" runat="server" />
        ...
        <div class="panel panel-info" style="width: 100%">
            <div class="panel-heading">
                <div class="modal-title text-center h1 ">
                    บันทึกเลข GFMIS<button type="button" class="btn btn-default pull-right" data-dismiss="modal">ปิดหน้าต่าง</button>
                </div>
