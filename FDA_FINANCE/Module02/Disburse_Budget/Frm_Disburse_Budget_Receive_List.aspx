<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Disburse_Budget_Receive_List.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_Budget_Receive_List" MaintainScrollPositionOnPostback="true" %>
 ...
 <table>
    ...
    <div class="modal fade" id="myModal3">
        <div class="panel panel-info" style="width: 100%">
            <div class="panel-heading">
                <div class="modal-title text-center h1 ">
                    กรอกเหตุผล การไม่อนุมัติ/ยกเลิก
                    <button type="button" class="btn btn-default pull-right" data-dismiss="modal">ปิดหน้าต่าง</button>
                </div>
                <div class="panel-body panel-info" style="width: 100%">
