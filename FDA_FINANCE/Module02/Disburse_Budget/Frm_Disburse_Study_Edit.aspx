<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Disburse_Study_Edit.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_Study_Edit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  <link href="../../css/css_validate/customMessages.css" rel="stylesheet" />
    ...
    <tr>
        ...
        <tr>
        <td>
        <asp:Button ID="btn_bill_save" runat="server" Text="แก้ไขใบเบิก" class="submit" />
        </td>
