Public Class Frm_Disburse_Budget_PayType_Direct_Receipt
    ...
    End Sub
    Public Sub set_uc()
        UC_Disburse_Budget_PayType_Direct_Receipt1.g = 1
        UC_Disburse_Budget_PayType_Direct_Receipt1.stat = 1
        UC_Disburse_Budget_PayType_Direct_Receipt1.bt = 2
        UC_Disburse_Budget_PayType_Direct_Receipt1.ispo = False
