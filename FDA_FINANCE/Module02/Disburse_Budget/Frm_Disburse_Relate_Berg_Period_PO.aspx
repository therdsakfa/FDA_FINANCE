<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Disburse_Relate_Berg_Period_PO.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_Relate_Berg_Period_PO" %>

<%@ Register src="UserControl/UC_RELATE_BILL_USER_BERG_PO.ascx" tagname="UC_RELATE_BILL_USER_BERG_PO" tagprefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
            <td>
                ...
                <uc1:UC_RELATE_BILL_USER_BERG_PO ID="UC_RELATE_BILL_USER_BERG_PO1" runat="server" />
