<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Disburse_Budget_Deeka_Number_Insert.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_Budget_Deeka_Number_Insert" %>
...
<%@ Register src="UserControl/UC_Disburse_Budget_Deeka_Number_Detail.ascx" tagname="UC_Disburse_Budget_Deeka_Number_Detail" tagprefix="uc2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
            <td>
                ...
                <uc2:UC_Disburse_Budget_Deeka_Number_Detail ID="UC_Disburse_Budget_Deeka_Number_Detail1" runat="server" />
            </td>
        </tr>
        <tr>
        <td align="center"> <br />
