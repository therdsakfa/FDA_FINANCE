Public Class Frm_Disburse_Cure_Deeka_Number_Insert
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            dao.Getdata_by_CURE_STUDY_ID(_bid)
            UC_Disburse_Cure_Study_Deeka_Number_Detail1.getdata(dao)
        End If
    End Sub
    ...
    Private Sub btn_bill_save_Click(sender As Object, e As EventArgs) Handles btn_bill_save.Click
        Dim dao As New DAO_DISBURSE.TB_CURE_STUDY
        dao.Getdata_by_CURE_STUDY_ID(_bid)
        UC_Disburse_Cure_Study_Deeka_Number_Detail1.insert(dao)
