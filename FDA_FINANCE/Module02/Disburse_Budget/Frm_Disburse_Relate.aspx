<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Disburse_Relate.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_Relate" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
 ...
 <%--   <link href="../../Scripts/jquery-ui.css" rel="stylesheet" type="text/css" /> 
    ...
    <script src="../../Html5/html5shiv.min.js" type="text/javascript"></script>
    <script src="../../Html5/respond.min.js" type="text/javascript"></script>
