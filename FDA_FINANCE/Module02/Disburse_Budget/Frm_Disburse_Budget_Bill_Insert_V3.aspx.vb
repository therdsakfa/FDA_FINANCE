Public Class Frm_Disburse_Budget_Bill_Insert_V3
    ...
    Private Sub btn_bill_save_Click(sender As Object, e As EventArgs) Handles btn_bill_save.Click
        ...
        '--------มันอนุมัติอัตโนมัติ-------ไม่มีปุ่มส่งเรื่อง-------
        ...
        Dim uri As String = ""
        uri = Request.Url.AbsoluteUri & "&bid=" & dao.fields.BUDGET_DISBURSE_BILL_ID & dao.fields.RELATE_ID & "&Chk=1"
