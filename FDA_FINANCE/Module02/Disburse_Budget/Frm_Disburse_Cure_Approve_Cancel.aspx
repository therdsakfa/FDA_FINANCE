<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Disburse_Cure_Approve_Cancel.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_Cure_Approve_Cancel" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <table>
        ...
        <tr >
         ...
         <tr>
            <td>การยกเลิกการอนุมัติการเบิกค่ารักษาพยาบาล</td>
        </tr>
        <tr>
            <td>
