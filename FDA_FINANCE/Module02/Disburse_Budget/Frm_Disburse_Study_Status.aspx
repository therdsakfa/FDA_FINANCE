<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Disburse_Study_Status.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_Study_Status" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="panel panel-body"  style="width:100%;"> 
        บันทึกข้อมูลค่าเล่าเรียนบุตร</div>
