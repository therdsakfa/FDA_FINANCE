<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Disburse_Relate_Insert_HRD.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_Relate_Insert_HRD" %>
<%@ Register src="UserControl/UC_RELATE_BILL_DETAILV2.ascx" tagname="UC_RELATE_BILL_DETAILV2" tagprefix="uc1" %>
<%@ Register src="UserControl/UC_RELATE_BILL_DETAILV2_Table.ascx" tagname="UC_RELATE_BILL_DETAILV2_Table" tagprefix="uc2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            showdate($("#ctl00_ContentPlaceHolder1_UC_RELATE_BILL_DETAILV21_txt_dodate"));
            //showdate($("#ctl00_ContentPlaceHolder1_UC_RELATE_BILL_DETAIL21_txt_travel_date"));
            ...
            $("#ctl00_ContentPlaceHolder1_UC_RELATE_BILL_DETAILV2_Table1_dd_BudgetAdjust").searchable();
            $("#ctl00_ContentPlaceHolder1_UC_RELATE_BILL_DETAILV2_Table1_ddl_GL").searchable();
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
            <td>
                ...
                <uc1:UC_RELATE_BILL_DETAILV2 ID="UC_RELATE_BILL_DETAILV21" runat="server" />
       ...
       <%-- <tr>
        ...
        <tr>
            <td>
                ...
                <uc2:UC_RELATE_BILL_DETAILV2_Table ID="UC_RELATE_BILL_DETAILV2_Table1" runat="server" />
                </asp:Panel>
            </td>
        </tr>
    </table>
