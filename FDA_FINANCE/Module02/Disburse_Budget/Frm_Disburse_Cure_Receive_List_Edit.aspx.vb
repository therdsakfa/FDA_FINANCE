Public Class Frm_Disburse_Cure_Receive_List_Edit
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        End If
        'UC_Disburse_Cure_Study_Detail1.is_insert =
        UC_Disburse_Cure_Study_Detail1.BudgetYear = bgYear
        UC_Disburse_Cure_Study_Detail1.BillType = 1
    ...
    Protected Sub btn_bill_save_Click(sender As Object, e As EventArgs) Handles btn_bill_save.Click
        ...
        If Request.QueryString("bid") IsNot Nothing Then
            ...
            log.insert_log(NameUserAD(), System.IO.Path.GetFileName(Request.Path), _
                           Request.Url.AbsoluteUri.ToString(), "รับเรื่องใบเบิกจ่ายค่ารักษา/ค่าเล่าเรียนเลขที่หนังสือ " & dao_disburse_bill.fields.DOC_NUMBER, "CURE_STUDY", Request.QueryString("bid"))
