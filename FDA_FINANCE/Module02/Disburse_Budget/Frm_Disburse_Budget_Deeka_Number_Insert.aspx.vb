Public Class Frm_Disburse_Budget_Deeka_Number_Insert
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            UC_Disburse_Budget_Deeka_Number_Detail1.getdata(dao)
        End If
    End Sub
    ...
    Private Sub btn_bill_save_Click(sender As Object, e As EventArgs) Handles btn_bill_save.Click
        ...
        If dao.fields.DEEKA_NUMBER <> "" Then
            System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "alert('เพิ่มฏีกาซํ้าอีกไม่ได้แล้ว') ;parent.$('#ctl00_ContentPlaceHolder1_btnRedirect').click(); ", True)
        ElseIf dao.fields.DEEKA_DATE IsNot Nothing Then
            System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "alert('เพิ่มฏีกาซํ้าอีกไม่ได้แล้ว') ;parent.$('#ctl00_ContentPlaceHolder1_btnRedirect').click(); ", True)
        Else
            UC_Disburse_Budget_Deeka_Number_Detail1.insert(dao)
