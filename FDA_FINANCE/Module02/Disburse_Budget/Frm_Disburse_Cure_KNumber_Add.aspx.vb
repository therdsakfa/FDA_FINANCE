Public Class Frm_Disburse_Cure_KNumber_Add
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        If Request.QueryString("bid") IsNot Nothing Then
            ...
            bool = dao_welfare.chk_exist_cure(id)
            dao.Getdata_by_CURE_STUDY_ID(id)
            UC_Disburse_Cure_GF_Detail1.insert(dao)
            ...
            If bool = False Then
                UC_Disburse_Cure_GF_Detail1.insert_welfare(id)
            End If
            Dim log As New log_event.log
            log.insert_log(NameUserAD(), System.IO.Path.GetFileName(Request.Path), _
                           Request.Url.AbsoluteUri.ToString(), "บันทึกขบ.ใบเบิกจ่ายค่ารักษา/ค่าเล่าเรียนเลขที่หนังสือ " & dao.fields.DOC_NUMBER, "CURE_STUDY", id)
