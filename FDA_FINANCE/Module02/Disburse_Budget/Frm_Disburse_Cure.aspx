<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Disburse_Cure.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_Cure" EnableEventValidation="false" %>
<%@ Register assembly="Telerik.Web.UI" namespace="Telerik.Web.UI" tagprefix="telerik" %>

<%@ Register src="UserControl/UC_Search_From_Cure_Study.ascx" tagname="UC_Search_From_Cure_Study" tagprefix="uc1" %>
<%@ Register Src="~/Module02/Disburse_Budget/UserControl/UC_Disburse_Welfare.ascx" TagPrefix="uc2" TagName="UC_Disburse_Welfare" %>
        ...
        <script type="text/javascript" >
            $(document).ready(function () {
                ...
                $('#ctl00_ContentPlaceHolder1_btn_Add').click(function () {
                    ...
                    Popups('Frm_Disburse_Welfare_Insert.aspx?bgid=' + bgid.toString() + '&bgYear=' + bgYear.toString() + '&dept=' + select_dept.toString() + "&g=8&stat=1");
                    return false;
                });
...
<div class="panel panel-body"  style="width:100%;">            
            <table width="100%">
                <tr><td>บันทึกเบิกจ่ายค่ารักษาพยาบาล</td><td align="right">
                    <table>
                        <tr>
                            <td>วันที่ &nbsp;</td>
                            <td>
   ...
   <%--             <uc2:UC_Disburse_Cure_Study ID="UC_Disburse_Cure_Study1" runat="server" />--%>
                <uc2:UC_Disburse_Welfare runat="server" id="UC_Disburse_Welfare1" />
            </td></tr>
