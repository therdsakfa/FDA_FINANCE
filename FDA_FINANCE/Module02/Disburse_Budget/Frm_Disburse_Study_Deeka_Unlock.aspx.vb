Public Class Frm_Disburse_Study_Deeka_Unlock
    ...
    Public Sub set_uc()
        Try
            UC_Disburse_Cure_Study_Deeka_Unlock1.bt = 2
            UC_Disburse_Cure_Study_Deeka_Unlock1.BudgetID = _bgid
            UC_Disburse_Cure_Study_Deeka_Unlock1.BudgetUseID = 1
            UC_Disburse_Cure_Study_Deeka_Unlock1.g = 9
            UC_Disburse_Cure_Study_Deeka_Unlock1.stat = 8
            UC_Disburse_Cure_Study_Deeka_Unlock1.BudgetYear = bgYear
            UC_Disburse_Cure_Study_Deeka_Unlock1.bill_type = 2
        Catch ex As Exception
    ...
    Private Sub btnSearch_Click(sender As Object, e As EventArgs) Handles btnSearch.Click
        ...
        UC_Disburse_Cure_Study_Deeka_Unlock1.rgFilter(str)
    End Sub
    ...
    Protected Sub btn_approve_Click(sender As Object, e As EventArgs) Handles btn_approve.Click
        If rd_APPROVE_DATE.IsEmpty = False Then
            UC_Disburse_Cure_Study_Deeka_Unlock1.update_true(rd_APPROVE_DATE.SelectedDate, _CLS.CITIZEN_ID_AUTHORIZE, 8)
            System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "alert('อนุมัติเรียบร้อยแล้ว') ;", True)
            set_uc()
            UC_Disburse_Cure_Study_Deeka_Unlock1.rebind_grid()
        Else
    ...
    Private Sub btn_no_approve_Click(sender As Object, e As EventArgs) Handles btn_no_approve.Click
        UC_Disburse_Cure_Study_Deeka_Unlock1.update_false(11)
