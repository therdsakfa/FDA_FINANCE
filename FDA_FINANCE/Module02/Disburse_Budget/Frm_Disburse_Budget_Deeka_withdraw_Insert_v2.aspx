<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Disburse_Budget_Deeka_withdraw_Insert_v2.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_Budget_Deeka_withdraw_Insert_v2" %>
  ...
  <link href="../../css/css_validate/customMessages.css" rel="stylesheet" />
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            showdate($("#ctl00_ContentPlaceHolder1_UC_deeka_withdraw_add_V21_deeka_date"));
