<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Disburse_Relate_Head_Approve.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_Relate_Head_Approve" %>
...
<%@ Register src="UserControl/UC_RELATE_BILL_WITH_HEAD_APPROVE.ascx" tagname="UC_RELATE_BILL_WITH_HEAD_APPROVE" tagprefix="uc1" %>
    ...
    <script type="text/javascript" >
        $(document).ready(function () {
            ...
            $('#ctl00_ContentPlaceHolder1_btn_Add').click(function () {
                ...
                var select_dept = getQuerystring('dept');
                //alert('55555555555');
                Popups('Frm_Disburse_Relate_Insert.aspx?bgid=' + bgid.toString() + '&bgYear=' + bgYear.toString() + '&dept=' + select_dept.toString());
                return false;
            });
    ...
    <div class="panel panel-body"  style="width:100%;">
          ...
          <%--          <asp:Button ID="btn_download" runat="server" CssClass="btn-lg " Text="ดาวน์โหลดคำขอ" Width="170px" />
            ...
            <asp:Button ID="Button1" runat="server" Text="Button" Style="display: none" />
                    <table >
                        ...
                        <DatePopupButton HoverImageUrl="" ImageUrl="" />
                            ...
                            <td>
                                <asp:Button ID="btn_approve" runat="server" CssClass="btn-lg" Text="ยืนยัน" Width="100px" />
                            </td>
                        </tr>
                    </table>
            ...
            <tr><td colspan="3">
                ...
                <uc1:UC_RELATE_BILL_WITH_HEAD_APPROVE ID="UC_RELATE_BILL_WITH_HEAD_APPROVE1" runat="server" />
                </td></tr>
        ...
        <div class="panel panel-info" style="width: 100%">
            <div class="panel-heading">
                <div class="modal-title text-center h1 ">
                    บันทึกผูกพันเงิน<button type="button" class="btn btn-default pull-right" data-dismiss="modal">ปิดหน้าต่าง</button>
                </div>
