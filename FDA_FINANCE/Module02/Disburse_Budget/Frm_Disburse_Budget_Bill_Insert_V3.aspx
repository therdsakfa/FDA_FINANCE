<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Disburse_Budget_Bill_Insert_V3.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_Budget_Bill_Insert_V3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="Panel1" runat="server" GroupingText="บันทึกการเบิกเงินงบประมาณ">
    <table width="100%">
    <tr>
            <td>
