<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Disburse_Budget_PayType_Pass_Check_Ready.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_Budget_PayType_Pass_Check_Ready" %>
<%@ Register assembly="Telerik.Web.UI" namespace="Telerik.Web.UI" tagprefix="telerik" %>
<%@ Register src="UserControl/UC_Search_Form.ascx" tagname="UC_Search_Form" tagprefix="uc3" %>

<%@ Register src="UserControl/UC_Disburse_Budget_PayType_Pass_Check_Ready.ascx" tagname="UC_Disburse_Budget_PayType_Pass_Check_Ready" tagprefix="uc1" %>
