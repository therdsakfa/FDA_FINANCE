Public Class Frm_Disburse_Relate_Overview_HRD
    ...
    Public Sub set_uc()
        UC_RELATE_BILL_HDR1.bg_use = 1

        Try
            UC_RELATE_BILL_HDR1.BudgetYear = Request.QueryString("myear") 'Master.get_Year()
            UC_Budget_Amount_Detail1.Budgetyear = Request.QueryString("myear")
        Catch ex As Exception

        End Try
        Try
            UC_RELATE_BILL_HDR1.dept = dd_Department.SelectedValue
            UC_Budget_Amount_Detail1.dept = dd_Department.SelectedValue
        Catch ex As Exception

        End Try
        Try
            UC_RELATE_BILL_HDR1.ProId = _ProId
            UC_Budget_Amount_Detail1.ProId = _ProId

            UC_RELATE_BILL_HDR1.BudgetID = _bgid
    ...
    Private Sub btnRedirect_Click(sender As Object, e As EventArgs) Handles btnRedirect.Click
        'bind_dl_bg()
        set_uc()
        UC_RELATE_BILL_HDR1.rebind_grid()
    End Sub
