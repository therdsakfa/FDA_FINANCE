Public Partial Class Frm_Disburse_Budget_PayType_Direct
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        RunSession()
        Page.Title = "รายการจ่ายตรง (งบประมาณ)"
        UC_Disburse_Budget_PayType_Direct1.ispo = "False"
        UC_Disburse_Budget_PayType_Direct1.PAY_TYPE_ID = 1
        UC_Disburse_Budget_PayType_Direct1.bg_use = 1
        UC_Disburse_Budget_PayType_Direct1.bgyear = Request.QueryString("myear")
        'UC_Disburse_Budget_PayType_Direct1.digit = dd_status.SelectedValue
    End Sub
    ...
    Private Sub ImageButton1_Click(sender As Object, e As ImageClickEventArgs) Handles ImageButton1.Click
        UC_Disburse_Budget_PayType_Direct1.rgFilter("([digit] like '%รอบันทึกบก. อนุมัติ%')")
    End Sub
