<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Disburse_Cure_Approve_OK.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_Cure_Approve_OK" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#ctl00_ContentPlaceHolder1_btn_Add').click(function () {
                ...
                openform("Frm_Disburse_Cure_Insert.aspx?bgyear=" + bgYear, "#if1"); //ใส่ url, ID iframe
                return false;
            });
        });
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="panel panel-body"  style="width:100%;">
        การอนุมัติการเบิกค่ารักษาพยาบาล
        </div>
    <div class="panel panel-body"  style="width:100%;">
