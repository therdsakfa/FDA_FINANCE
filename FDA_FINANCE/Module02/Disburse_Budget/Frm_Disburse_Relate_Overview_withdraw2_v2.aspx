<%@ Page Language="vb" AutoEventWireup="false"  MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Disburse_Relate_Overview_withdraw2_v2.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_Relate_Overview_withdraw2_v2" %>

<%@ Register Src="~/Module02/Disburse_Budget/UserControl/UC_Disburse_Budget_Bill_withdraw2.ascx" TagPrefix="uc3" TagName="UC_Disburse_Budget_Bill_withdraw2" %>
...
<%--               <uc1:UC_Disburse_Budget_Bill_withdraw ID="UC_Disburse_Budget_Bill_withdraw1" runat="server" />
               ...
               <uc3:UC_Disburse_Budget_Bill_withdraw2 runat="server" id="UC_Disburse_Budget_Bill_withdraw21" />
            </td>
        </tr>
    </table>
 </div>   
