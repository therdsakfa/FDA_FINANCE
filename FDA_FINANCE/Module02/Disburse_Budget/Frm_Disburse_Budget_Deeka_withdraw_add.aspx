<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Disburse_Budget_Deeka_withdraw_add.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_Budget_Deeka_withdraw_add" %>


<%--<%@ Register src="../../UC/UC_Project_Information.ascx" tagname="UC_Project_Information" tagprefix="uc5" %>--%>
<%@ Register assembly="Telerik.Web.UI" namespace="Telerik.Web.UI" tagprefix="telerik" %>
<%@ Register Src="~/Module02/Disburse_Budget/UserControl/UC_deeka_withdraw_add_Show.ascx" TagName="UC_deeka_withdraw_add_Show" TagPrefix="uc1" %>
        ...
        <div class="panel panel-body"  style="width:100%;display:none;">
            ...
            <div class="panel panel-body"  style="width:100%;">
                ...
                Height="55px" />
                    ...
                    <tr>
                        <td>
                            <uc1:UC_deeka_withdraw_add_Show ID="UC_deeka_withdraw_add_Show" runat="server" />
