Public Class Frm_Disburse_Study
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        RunSession()
        runQuery()
        UC_Disburse_Cure_Study1.BillType = 2
        UC_Disburse_Cure_Study1.BudgetYear = Request.QueryString("myear")
    ...
    Public Sub set_uc()
        Try
            UC_Disburse_Cure_Study1.bt = 2
            UC_Disburse_Cure_Study1.g = 8
            UC_Disburse_Cure_Study1.stat = 1
    ...
    Private Sub btnSearch_Click(sender As Object, e As EventArgs) Handles btnSearch.Click
        ...
        UC_Disburse_Cure_Study1.rgFilter(str)
    End Sub

    Private Sub Page_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        UC_Disburse_Cure_Study1.bindseq()
    End Sub
    ...
    Protected Sub btn_approve_Click(sender As Object, e As EventArgs) Handles btn_approve.Click
        If rd_APPROVE_DATE.IsEmpty = False Then
            If UC_Disburse_Cure_Study1.chk_selected = True Then
                If ddl_approve.SelectedValue = "1" Then
                    UC_Disburse_Cure_Study1.insert_approve(rd_APPROVE_DATE.SelectedDate, _CLS.CITIZEN_ID_AUTHORIZE)
                Else
                    If UC_Disburse_Cure_Study1.chk_selected_count <= 1 Then
                        UC_Disburse_Cure_Study1.open_reject_note()
                    Else
                ...
                End If
                set_uc()
                UC_Disburse_Cure_Study1.rg_rebind()
            Else
