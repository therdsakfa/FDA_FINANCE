<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Disburse_Relate_Edit2.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_Relate_Edit2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="Panel1" runat="server" GroupingText="แก้ไขผูกพันเงินงบประมาณ">
    <table width="100%">
    <tr>
            <td>
        ...
        <td align="center">
            <table>
                <tr>
                    <td><asp:Button ID="btn_confirm" runat="server" Text="แก้ไข" style="width: 132px" /></td>
                    <td><asp:Button ID="btn_bill_save" runat="server" Text="แก้ไข" style="display:none;"/></td>
