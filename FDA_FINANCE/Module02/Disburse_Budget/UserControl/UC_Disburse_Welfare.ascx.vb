...
Public Class UC_Disburse_Welfare
    ...
    Private Sub rg_Disburse_Cure_Study_ItemDataBound(sender As Object, e As GridItemEventArgs) Handles rg_Disburse_Cure_Study.ItemDataBound
        If e.Item.ItemType = GridItemType.AlternatingItem Or e.Item.ItemType = GridItemType.Item Then
            ...
            Dim url As String = "Frm_Disburse_Welfare_Edit.aspx?bid=" & item("CURE_STUDY_ID").Text & "&bgyear=" & BudgetYear & "&dept=" & Request.QueryString("dept")
