...
Public Class UC_Disburse_Budget_PayType_Pass_Check_Pay
    ...
    Private Sub rg_check_pay_Init(sender As Object, e As EventArgs) Handles rg_check_pay.Init
        Dim Rad_Utility As New Radgrid_Utility
        Rad_Utility.Rad = rg_check_pay
    ...
    End Sub
    Private Sub rg_check_ready_NeedDataSource(sender As Object, e As GridNeedDataSourceEventArgs) Handles rg_check_pay.NeedDataSource
        Dim dt As New DataTable
        Dim bao As New BAO_BUDGET.DISBURSE_BUDGET

        If is_rebill = True Then
            dt = bao.get_bill_check_pay_rebill_V2(bg_use, bgyear, stat - 1, g)
            dt.Columns.Add("stat")
        ElseIf is_no_rebill = True Then
            dt = bao.get_bill_check_pay_no_rebill(bg_use, bgyear, stat - 1, g)
            dt.Columns.Add("stat")
        Else
            dt = bao.get_bill_check_pay_V3(bg_use, bgyear, stat - 1, g)
            dt.Columns.Add("stat")
        End If
        ...
        For Each dr As DataRow In dt.Rows
            ...
            End If
        Next
        rg_check_pay.DataSource = dt
    End Sub
    Public Sub rgFilter(ByVal str As String)
        Dim uti_filter As New Utility_other
        uti_filter.filter_rg(rg_check_pay, str)
    End Sub
    ...
    Public Sub update_true(ByVal date_input As Date, ByVal iden As String)
        For Each item As GridDataItem In rg_check_pay.SelectedItems
            ...
            If item("id_det").Text <> "" Then
                ...
                For i As Integer = 0 To arr_det.Length - 1
                    Try
                        ...
                        dao_det.fields.IS_PAY_CHECK = True
                        dao_det.fields.PAY_CHECK_DATE = Date.Now
                        dao_det.update()
