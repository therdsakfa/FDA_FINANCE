...
Public Class UC_Disburse_Budget_Bill_withdraw2
    ...
    Private Sub rgAddKNumber_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles rgAddKNumber.Init
        ...
        Rad_Utility.addColumnBound("DESCRIPTION", "รายการ", width:=150)
        Rad_Utility.addColumnBound("GL_NAME", "หมวดค่าใช้จ่าย", width:=150)
        Rad_Utility.addColumnBound("AMOUNT", "จำนวนเงิน", width:=100, is_money:=True)
        '  Rad_Utility.addColumnButton("A", "เพิ่มรายละเอียดการเบิก", "A", 0, "")
        Rad_Utility.addColumnButton("B", "เพิ่มรายละเอียดการเบิกฏีกา", "B", 0, "")
    ...
    Private Sub rgAddKNumber_ItemDataBound(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridItemEventArgs) Handles rgAddKNumber.ItemDataBound
        ...
        If e.Item.ItemType = GridItemType.AlternatingItem Or e.Item.ItemType = GridItemType.Item Then
            ...
            lnk_ist = "../../Module02/Disburse_Budget/Frm_Disburse_Budget_add_withdraw.aspx?bid=" & item("BUDGET_DISBURSE_BILL_ID").Text & "&stat=" & _stat & "&g=" & _g & "&bt=" & _bt & "&det=" & item("DETAIL_ID").Text & "&dept=" & Request.QueryString("dept") & "&bgyear=" & Request.QueryString("myear")
