...
Public Class UC_RELATE_BILL
            ...
            ElseIf e.CommandName = "B" Then
                ...
                Try
                    ...
                    If dao.fields.RELATE_TYPE <> 3 Then
                        ' Response.Redirect("Frm_Disburse_Relate_Berg_Period.aspx?bid=" & item("RELATE_ID").Text & "&dept=" & _dept & "&myear=" & _BudgetYear) 'ไม่ใช่ po
                        Response.Redirect("Frm_Disburse_PO.aspx?bgid=" & item("RELATE_ID").Text & "&dept=" & _dept & "&myear=" & _BudgetYear) 'ไม่ใช่ po
                    Else
                        ' url = "Frm_Disburse_Relate_Berg_Period_PO.aspx?bid=" & item("RELATE_ID").Text
                        Response.Redirect("Frm_Disburse_PO.aspx?bgid=" & item("RELATE_ID").Text & "&dept=" & _dept & "&myear=" & _BudgetYear)
    ...
    Private Sub rg_relate_ItemDataBound(sender As Object, e As GridItemEventArgs) Handles rg_relate.ItemDataBound
        If e.Item.ItemType = GridItemType.AlternatingItem Or e.Item.ItemType = GridItemType.Item Then
            ...
            ElseIf dao.fields.STATUS_ID >= 3 Then
                ...
                If dao_d.fields.RELATE_DETAIL_ID = Nothing Then
                    B.Visible = False
                Else
                    B.Visible = True
                End If
    ...
    Private Sub rg_relate_NeedDataSource(sender As Object, e As GridNeedDataSourceEventArgs) Handles rg_relate.NeedDataSource
        ...
        dt = BudgetBill.get_relate_bill_V2(BudgetYear, dept, bg_use)
