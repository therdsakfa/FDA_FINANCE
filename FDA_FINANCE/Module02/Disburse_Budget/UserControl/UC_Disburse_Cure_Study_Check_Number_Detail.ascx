<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UC_Disburse_Cure_Study_Check_Number_Detail.ascx.vb" Inherits="FDA_FINANCE.UC_Disburse_Cure_Study_Check_Number_Detail" %>
