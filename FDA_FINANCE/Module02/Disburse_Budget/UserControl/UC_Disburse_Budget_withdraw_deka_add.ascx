            ...
            <td style="width: 65%">
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td style="width: 80%">
                            <asp:TextBox ID="txt_deka_date" Enabled="false" runat="server" Height="30px" Width="30%"></asp:TextBox>
                        </td>
                    </tr>
                       <tr>
                        <td align="right" style="width: 20%">ประเภทฏีกา :</td>
                        <td style="width: 80%">
                              <asp:DropDownList ID="dd_typeDeka" Enabled="false" runat="server" AutoPostBack="true" DataValueField="ID" DataTextField="TypePay_Deka_Name" Height="30px" Width="40%">
                            </asp:DropDownList>
                        </td>
                    </tr>
                     <tr>
                        ...
                        <td style="width: 80%">
                       <asp:TextBox ID="txt_DekaNum" runat="server" Enabled="false" Height="30px" Width="30%" ></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" style="width: 20%">ชื่อผู้เบิก :</td>
                        <td style="width: 80%">
                            <asp:DropDownList ID="dd_disburse_Name" Enabled="false" runat="server" Height="30px" Width="90%" DataValueField="IDA" DataTextField="Name_Disburse">
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td style="width: 30%">
                            <asp:DropDownList ID="dd_payW" runat="server" Enabled="false" DataValueField="ID" DataTextField="BG_TypeMoneyW" Height="30px" Width="80%">
                            </asp:DropDownList>
                        </td>
                        <td style="width: 20%">ที่คลังรับใบกันเงิน :          
                        </td>
                        <td style="width: 30%">
                            <asp:TextBox ID="txt_treasury" runat="server" Enabled="false" Height="30px" Width="75%" ></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" style="width: 20%">ประจำเดือน : </td>
                        <td style="width: 30%">
                            <asp:DropDownList ID="dd_month" runat="server" Enabled="false" DataValueField="Month_number" DataTextField="Month_name" Height="30px" Width="80%">
                            </asp:DropDownList>
                        </td>
                        <td align="right" style="width: 20%">งบประมาณปี :
                        </td>
                        <td style="width: 20%">
                                 <asp:DropDownList ID="ddl_year" runat="server" Enabled="false" DataValueField="BUDGET_PLAN_ID" DataTextField="BUDGET_DESCRIPTION" Height="30px" Width="75%">
                            </asp:DropDownList>
                        </td>
                    </tr>
                </table>
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td style="width: 80%">
                              <asp:DropDownList ID="ddl_BudgetGroup" runat="server" Enabled="false" Height="30px" Width="40%">
                    ...
                    <tr>
                        ...
                        <td style="width: 80%">
                            <asp:DropDownList ID="ddl_plan" runat="server" Enabled="false" Height="30px" Width="90%"  AutoPostBack="True"></asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 80%">
                             <asp:DropDownList ID="ddl_product" runat="server" Enabled="false" Height="30px" Width="90%" AutoPostBack="True">
                    </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 80%">
                                <asp:DropDownList ID="ddl_act" runat="server" Enabled="false" Height="30px" Width="90%" AutoPostBack="True">
                    </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 80%">
                            <asp:DropDownList ID="dd_pay" runat="server" Enabled="false" DataValueField="ID" DataTextField="BG_PayTypeName" Height="30px" Width="30%">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 80%">
                            <asp:DropDownList ID="dd_Bank" runat="server" DataValueField="BANK_ID" Enabled="false" DataTextField="BANK_NAME" Height="30px" Width="30%">
                            </asp:DropDownList>
                        </td>
                    </tr>
                </table>
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td style="width: 80%">
                            <asp:DropDownList ID="dd_Account" runat="server"  DataValueField="IDA" Enabled="false" DataTextField="ACCOUNTNAME"  Height="30px" Width="90%" AutoPostBack="true">
