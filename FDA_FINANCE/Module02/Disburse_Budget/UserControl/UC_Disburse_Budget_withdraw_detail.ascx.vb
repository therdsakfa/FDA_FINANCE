...
Public Class UC_Disburse_Budget_withdraw_detail
    ...
    Private Sub rg_Budget_Receive_List_Init(sender As Object, e As EventArgs) Handles rg_Budget_Receive_List.Init
        ...
        Rad_Utility.addColumnDate("GL_NAME", "หมวดรายจ่าย")
        ...
        Rad_Utility.addColumnButton("d", "เพิ่มรายละเอียดตรวจสอบ", "d", 0, "")
        Rad_Utility.addColumnButton("d2", "เพิ่มรายละเอียดเบิกฏีกา", "d2", 0, "")
        Rad_Utility.addColumnButton("d3", "รายงานใบฏีกา", "d3", 0, "")
        'Rad_Utility.addColumnButton("d4", "รายงานแบบ บก.28", "d4", 0, "")
    ...
    Private Sub rg_Budget_Receive_List_ItemDataBound(sender As Object, e As Telerik.Web.UI.GridItemEventArgs) Handles rg_Budget_Receive_List.ItemDataBound
        If e.Item.ItemType = GridItemType.AlternatingItem Or e.Item.ItemType = GridItemType.Item Then
            ...
            'item "d"
            Dim btn_review As LinkButton = DirectCast(item("d").Controls(0), LinkButton)
            'item "d2"
            Dim btn_add_deka As LinkButton = DirectCast(item("d2").Controls(0), LinkButton)
            Dim btn_report1 As LinkButton = DirectCast(item("d3").Controls(0), LinkButton)
            'Dim btn_report2 As LinkButton = DirectCast(item("d4").Controls(0), LinkButton)
            ...
            'เพิ่มการเบิก
            Dim url3 As String = "../../Module02/Disburse_Budget/Frm_Disburse_Budget_add_withdraw.aspx?bid=" & id & "&bgid=" & BudgetID & "&bgYear=" & bgyear & "&dept=" & dao_bill.fields.DEPARTMENT_ID & "&bit=1"
            btn_review.Attributes.Add("OnClick", "Popups('" & url3 & "'); return false;")
            'เพิ่มฏีกา
            Dim url4 As String = "../../Module02/Disburse_Budget/Frm_Disburse_Budget_add_withdraw_deka.aspx?bid=" & id & "&bgid=" & BudgetID & "&bgYear=" & bgyear & "&dept=" & dao_bill.fields.DEPARTMENT_ID & "&bit=1"
            btn_add_deka.Attributes.Add("OnClick", "Popups2('" & url4 & "'); return false;")
            ...
            Dim url3_1 As String = "../../../Module02/Report/Frm_Report_R2_028.aspx?bid=" & id & "&bgid=" & BudgetID & "&bgYear=" & bgyear & "&dept=" & dao_bill.fields.DEPARTMENT_ID & "&bit=1"
            btn_report1.PostBackUrl = url3_1


            'Dim url4_1 As String = "../../../Module02/Report/Frm_Report_R2_029.aspx?bid=" & id & "&bgid=" & BudgetID & "&bgYear=" & bgyear & "&dept=" & dao_bill.fields.DEPARTMENT_ID & "&bit=1"
            'btn_report2.PostBackUrl = url4_1
