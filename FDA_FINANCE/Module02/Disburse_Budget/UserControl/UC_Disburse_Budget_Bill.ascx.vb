...
Partial Public Class UC_Disburse_Budget_Bill
    ...
    Private Sub rgAddKNumber_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles rgAddKNumber.Init
        ...
        Rad_Utility.addColumnButton("A", "เพิ่มเลขขบ.", "A", 0, "")
    ...
    Private Sub rgAddKNumber_ItemDataBound(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridItemEventArgs) Handles rgAddKNumber.ItemDataBound
        ...
        If e.Item.ItemType = GridItemType.AlternatingItem Or e.Item.ItemType = GridItemType.Item Then
            ...
            lnk_ist = "../../Module02/Disburse_Budget/Frm_Disburse_Budget_Bill_Insert_Detail.aspx?bid=" & item("BUDGET_DISBURSE_BILL_ID").Text & "&stat=" & _stat & "&g=" & _g & "&bt=" & _bt & "&det=" & item("DETAIL_ID").Text
            ...
            If item("GFMIS_NUMBER").Text = "" Or item("GFMIS_NUMBER").Text = "&nbsp;" Then
                btn_report2.Style.Add("display", "none")
            Else
                btn_report2.Style.Add("display", "block")
            End If

            Dim url4_1 As String = "../../../Module02/Report/Frm_Report_R2_029.aspx"
