...
Public Class UC_Disburse_Cure_GF
    ...
    Private Sub rgAddKNumber_ItemDataBound(sender As Object, e As GridItemEventArgs) Handles rgAddKNumber.ItemDataBound
        If e.Item.ItemType = GridItemType.AlternatingItem Or e.Item.ItemType = GridItemType.Item Then
            ...
            Dim id As String = ""
            id = "Frm_Disburse_Cure_KNumber_Add.aspx?bid=" & item("CURE_STUDY_ID").Text & "&stat=" & stat & "&g=" & g & "&bt=" & bt
    ...
    Private Sub rgAddKNumber_NeedDataSource(sender As Object, e As GridNeedDataSourceEventArgs) Handles rgAddKNumber.NeedDataSource
        ...
        Dim dt As DataTable = bao.getGF_cure_study_v2(Budgetyear, btype, stat, g)
        dt.Columns.Add("pay_type")
        For Each dr As DataRow In dt.Rows
            If IsDBNull(dr("INCLUDE_SALARY_DIGIT")) = False Then
                If dr("INCLUDE_SALARY_DIGIT") = "1" Then
                    dr("pay_type") = "เข้าเงินเดือน"
                ElseIf dr("INCLUDE_SALARY_DIGIT") = "2" Then
                    dr("pay_type") = "ไม่เข้าเงินเดือน"
                End If
            End If
