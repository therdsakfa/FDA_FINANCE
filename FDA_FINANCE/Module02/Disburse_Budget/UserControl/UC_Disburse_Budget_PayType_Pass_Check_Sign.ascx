<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UC_Disburse_Budget_PayType_Pass_Check_Sign.ascx.vb" Inherits="FDA_FINANCE.UC_Disburse_Budget_PayType_Pass_Check_Sign" %>
