...
Public Class UC_Disburse_Budget_DetailV3_Table
    ...
    Public Function chk_amount(ByVal bgid As Integer, ByVal amount As Double) As Boolean
        ...
        Return bool
    End Function
    'Private Sub ddl_acount_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ddl_acount.SelectedIndexChanged
    '    show_img_tooltip()
    'End Sub
End Class