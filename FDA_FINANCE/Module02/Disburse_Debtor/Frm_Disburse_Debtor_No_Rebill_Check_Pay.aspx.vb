Public Class Frm_Disburse_Debtor_No_Rebill_Check_Pay
    ...
    Public Sub set_uc()
        ...
        UC_Disburse_Budget_PayType_Pass_Check_Pay1.stat = 10
        UC_Disburse_Budget_PayType_Pass_Check_Pay1.g = 4
        UC_Disburse_Budget_PayType_Pass_Check_Pay1.is_no_rebill = True
    End Sub
