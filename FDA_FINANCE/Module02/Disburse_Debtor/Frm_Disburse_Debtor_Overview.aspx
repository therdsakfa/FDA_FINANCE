<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Disburse_Debtor_Overview.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_Debtor_Overview" %>
...
<%@ Register src="UserControl/UC_Disburse_Debtor_With_Approve.ascx" tagname="UC_Disburse_Debtor_With_Approve" tagprefix="uc3" %>
...
<div class="panel panel-body"  style="width:100%;">
            ...
            <tr><td colspan="2">
                <uc3:UC_Disburse_Debtor_With_Approve ID="UC_Disburse_Debtor_With_Approve1" runat="server" />
                </td></tr>
        ...
        <div class="panel panel-info" style="width: 100%">
            <div class="panel-heading">
                <div class="modal-title text-center h1 ">
                    บันทึกลูกหนี้เงินยืม<button type="button" class="btn btn-default pull-right" data-dismiss="modal" onclick="refresh()">ปิดหน้าต่าง</button>
                </div>
