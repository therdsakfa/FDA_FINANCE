<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Disburse_Debtor_Margin_Check_Pay.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_Debtor_Margin_Check_Pay" %>
...
<%@ Register src="UserControl/UC_Disburse_Debtor_Margin_Check_Pay.ascx" tagname="UC_Disburse_Debtor_Margin_Check_Pay" tagprefix="uc1" %>
            ...
            <table width="100%">
                ...
                <tr>
                    <td>
                        ...
                        <uc1:UC_Disburse_Debtor_Margin_Check_Pay ID="UC_Disburse_Debtor_Margin_Check_Pay1" runat="server" />
