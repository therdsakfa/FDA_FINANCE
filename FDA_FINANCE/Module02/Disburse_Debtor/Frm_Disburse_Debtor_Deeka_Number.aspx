<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Disburse_Debtor_Deeka_Number.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_Debtor_Deeka_Number" %>
<%@ Register src="../Disburse_Budget/UserControl/UC_Search_Form.ascx" tagname="UC_Search_Form" tagprefix="uc1" %>

<%@ Register src="UserControl/UC_Disburse_Debtor_Deeka_Number.ascx" tagname="UC_Disburse_Debtor_Deeka_Number" tagprefix="uc2" %>
