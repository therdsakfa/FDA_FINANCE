<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Disburse_Debtor_Bill_Insert_V2.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_Debtor_Bill_Insert_V2" %>
<%@ Register src="UserControl/UC_Disburse_Debtor_Detail_V2.ascx" tagname="UC_Disburse_Debtor_Detail_V2" tagprefix="uc1" %>
<%@ Register src="UserControl/UC_Disburse_Debtor_Detail_V2_Table.ascx" tagname="UC_Disburse_Debtor_Detail_V2_Table" tagprefix="uc2" %>
<%@ Register src="UserControl/UC_Disburse_Debtor_Detail_V3_Table.ascx" tagname="UC_Disburse_Debtor_Detail_V3_Table" tagprefix="uc3" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            showdate($("#ctl00_ContentPlaceHolder1_UC_Disburse_Debtor_Detail_V21_txt_DOC_DATE"));
            showdate($("#ctl00_ContentPlaceHolder1_UC_Disburse_Debtor_Detail_V21_txt_dodate"));
            ...
            $("#ctl00_ContentPlaceHolder1_UC_Disburse_Debtor_Detail_V2_Table1_dd_CUSTOMER").searchable();
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
            <td>
                ...
                <uc1:UC_Disburse_Debtor_Detail_V2 ID="UC_Disburse_Debtor_Detail_V21" runat="server" />
        ...
        <tr>
            <td>
                <asp:Panel ID="Panel2" runat="server" style="display:none;">
                    <uc2:UC_Disburse_Debtor_Detail_V2_Table ID="UC_Disburse_Debtor_Detail_V2_Table1" runat="server" /> 
                </asp:Panel>
                <asp:Panel ID="Panel3" runat="server" style="display:none;">
                <uc3:UC_Disburse_Debtor_Detail_V3_Table ID="UC_Disburse_Debtor_Detail_V3_Table1" runat="server" />
                </asp:Panel>
