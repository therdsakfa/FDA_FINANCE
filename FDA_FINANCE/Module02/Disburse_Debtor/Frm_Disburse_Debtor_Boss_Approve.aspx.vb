Public Class Frm_Disburse_Debtor_Boss_Approve
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        RunSession()
        runQuery()
        UC_Disburse_Debtor_Boss_Approve1.BudgetUseID = 1
        UC_Disburse_Debtor_Boss_Approve1.bgyear = bgYear
        UC_Disburse_Debtor_Boss_Approve1.g = 1
        UC_Disburse_Debtor_Boss_Approve1.bt = 3
        UC_Disburse_Debtor_Boss_Approve1.stat = 2
        UC_Disburse_Debtor_Boss_Approve1.g2 = 1
        UC_Disburse_Debtor_Boss_Approve1.stat2 = 2
    End Sub
