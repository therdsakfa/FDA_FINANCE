Public Class Frm_Disburse_Debtor_No_Rebill_Transfer_to_Bank
    ...
    Public Sub set_uc()
        ...
        UC_Disburse_Budget_Transfer_to_Customer1.is_po = False
        UC_Disburse_Budget_Transfer_to_Customer1.stat = 6
        UC_Disburse_Budget_Transfer_to_Customer1.g = 4
        UC_Disburse_Budget_Transfer_to_Customer1.is_no_rebill = True
    End Sub
    ...
    Private Sub btn_no_approve_Click(sender As Object, e As EventArgs) Handles btn_no_approve.Click
        UC_Disburse_Budget_Transfer_to_Customer1.update_false(6)
