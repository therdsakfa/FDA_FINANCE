Public Class Frm_Disburse_Debtor_Bill
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        UC_Disburse_Debtor_Bill1.BudgetUseID = 1
        UC_Disburse_Debtor_Bill1.bt = 3
        UC_Disburse_Debtor_Bill1.stat = 7
        UC_Disburse_Debtor_Bill1.g = 0
        UC_Disburse_Debtor_Bill1.stat2 = 1
        UC_Disburse_Debtor_Bill1.g2 = 1
    End Sub
