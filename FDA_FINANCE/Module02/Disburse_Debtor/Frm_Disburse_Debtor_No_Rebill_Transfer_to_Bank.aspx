<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Disburse_Debtor_No_Rebill_Transfer_to_Bank.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_Debtor_No_Rebill_Transfer_to_Bank" %>
...
<%@ Register src="~/Module02/Disburse_Budget/UserControl/UC_Disburse_Budget_Transfer_to_Customer.ascx" tagname="UC_Disburse_Budget_Transfer_to_Customer" tagprefix="uc2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <h3><font color="black">การโอนเงินเข้าบัญชี</font></h3>
</div>
...
<DatePopupButton ImageUrl="" HoverImageUrl=""></DatePopupButton>
                ...
                <asp:Button ID="btn_approve" runat="server" Text="โอน"  Width="100px"  CssClass="btn-lg"/>
            ...
            <tr><td colspan="3">
                ...
                <uc2:UC_Disburse_Budget_Transfer_to_Customer ID="UC_Disburse_Budget_Transfer_to_Customer1" runat="server" />
                </td></tr>
