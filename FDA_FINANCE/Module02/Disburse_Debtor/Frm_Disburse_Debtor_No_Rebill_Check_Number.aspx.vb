Public Class Frm_Disburse_Debtor_No_Rebill_Check_Number
    ...
    Public Sub set_uc()
        ...
        UC_Disburse_Budget_PayType_Pass_Check_Number1.stat = 7
        UC_Disburse_Budget_PayType_Pass_Check_Number1.g = 4
        UC_Disburse_Budget_PayType_Pass_Check_Number1.is_no_rebill = True
    End Sub
