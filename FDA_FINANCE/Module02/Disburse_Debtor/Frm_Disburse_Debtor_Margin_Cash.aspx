<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Disburse_Debtor_Margin_Cash.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_Debtor_Margin_Cash" %>
...
<%@ Register src="UserControl/UC_Disburse_Debtor_Margin_Cash.ascx" tagname="UC_Disburse_Debtor_Margin_Cash" tagprefix="uc3" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#ctl00_ContentPlaceHolder1_btn_Add').click(function () {
                ...
                openform("Frm_Disburse_Debtor_Bill_Margin_Insert.aspx?bguse=1&ex=1", "#if1"); //ใส่ url, ID iframe
                return false;
            });
        });
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="panel panel-body"  style="width:100%;">
                <h3><font color="black">ลูกหนี้เงินทดรอง (เงินสด)</font></h3>
</div>
    <div class="panel panel-body"  style="width:100%;">
    <table width="100%">
<tr> <td> 
    ...
    <tr>
        ...
        <tr>
            <td>
                 <table>
                     <tr>
                         <td colspan="4">ความหมายของสีดอกไม้
                                                      </td>
                     </tr>
                     <tr>
        ...
        <tr>
            ...
            <tr><td colspan="2">
                <uc3:UC_Disburse_Debtor_Margin_Cash ID="UC_Disburse_Debtor_Margin_Cash1" runat="server" />
                </td></tr>
...
<%--    <div id="dialog_edit" title="เพิ่มสถานะ" style="display:none">  
    ...
    <div class="modal fade" id="myModal2">
        <div class="panel panel-info" style="width: 100%">
            <div class="panel-heading">
                <div class="modal-title text-center h1 ">
                    บันทึกลูกหนี้เงินทดรองเงินสด <button type="button" class="btn btn-default pull-right" data-dismiss="modal">ปิดหน้าต่าง</button>
                </div>
                <div class="panel-body panel-info" style="width: 100%">
