<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Disburse_Debtor_Receive_List.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_Debtor_Receive_List" %>
<%@ Register assembly="Telerik.Web.UI" namespace="Telerik.Web.UI" tagprefix="telerik" %>
<%@ Register src="UserControl/UC_Disburse_Debtor_Receive_List.ascx" tagname="UC_Disburse_Debtor_Receive_List" tagprefix="uc1" %>
<%@ Register src="UserControl/UC_Receive_List_Filter.ascx" tagname="UC_Receive_List_Filter" tagprefix="uc2" %>
