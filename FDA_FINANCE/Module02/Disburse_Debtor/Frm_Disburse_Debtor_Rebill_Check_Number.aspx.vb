Public Class Frm_Disburse_Debtor_Rebill_Check_Number
    ...
    Public Sub set_uc()
        ...
        UC_Disburse_Budget_PayType_Pass_Check_Number1.g = 3
        UC_Disburse_Budget_PayType_Pass_Check_Number1.is_rebill = True
    End Sub
