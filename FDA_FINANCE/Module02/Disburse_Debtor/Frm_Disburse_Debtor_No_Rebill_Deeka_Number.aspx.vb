Public Class Frm_Disburse_Debtor_No_Rebill_Deeka_Number
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        UC_Disburse_Budget_Deeka_Number1.stat = 5
        UC_Disburse_Budget_Deeka_Number1.bt = 2
        UC_Disburse_Budget_Deeka_Number1.g = 4
        UC_Disburse_Budget_Deeka_Number1.is_no_rebill = True
