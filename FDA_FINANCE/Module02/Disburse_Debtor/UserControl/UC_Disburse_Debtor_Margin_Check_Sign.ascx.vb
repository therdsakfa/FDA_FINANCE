...
Public Class UC_Disburse_Debtor_Margin_Check_Sign
    ...
    Public Sub update_true(ByVal date_input As Date, ByVal iden As String)
        For Each item As GridDataItem In rg_check_sign.SelectedItems
            ...
            Dim dao3 As New DAO_DISBURSE.TB_DEBTOR_BILL_DETAIL
            dao3.Getdata_by_DEBTOR_BILL_ID(item("DEBTOR_BILL_ID").Text)
            dao3.fields.IS_CHECK_SIGN = True
            dao3.fields.CHECK_SIGN_DATE = date_input
            dao3.update()
