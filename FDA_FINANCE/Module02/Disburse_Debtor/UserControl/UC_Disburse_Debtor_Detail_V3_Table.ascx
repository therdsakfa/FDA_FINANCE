<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UC_Disburse_Debtor_Detail_V3_Table.ascx.vb" Inherits="FDA_FINANCE.UC_Disburse_Debtor_Detail_V3_Table" %>
