<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UC_Disburse_Debtor_Detail_V2_Table.ascx.vb" Inherits="FDA_FINANCE.UC_Disburse_Debtor_Detail_V2_Table" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<asp:Panel ID="Panel2" runat="server" GroupingText="เรื่องค่าใช้จ่าย">
                ...
                <telerik:RadGrid ID="RadGrid1" runat="server" AutoGenerateColumns="false" GridLines="None" width="100%" ShowFooter="true">
                    <MasterTableView>
                        <Columns>
                            ...
                            <telerik:GridBoundColumn UniqueName="DEBTOR_BILL_DETAIL_ID" HeaderText="DEBTOR_BILL_DETAIL_ID" DataField="DEBTOR_BILL_DETAIL_ID" Display="false" >
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn UniqueName="DEBTOR_BILL_ID" HeaderText="DEBTOR_BILL_ID" DataField="DEBTOR_BILL_ID" Display="false" >
                            </telerik:GridBoundColumn>
