...
Public Class UC_Disburse_Debtor_Margin_Check_Number
    ...
    Private Sub rgPayPass_chk_ItemDataBound(sender As Object, e As Telerik.Web.UI.GridItemEventArgs) Handles rg_debtor_chk_num.ItemDataBound
        If e.Item.ItemType = GridItemType.AlternatingItem Or e.Item.ItemType = GridItemType.Item Then
            ...
            Dim url As String = "../../Module02/Disburse_Debtor/Frm_Disburse_Debtor_Check_Number_Insert.aspx?bid=" & id & "&bt=" & _bt & "&stat=" & _stat & "&g=" & g
