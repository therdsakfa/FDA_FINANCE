...
Public Class UC_Disburse_Debtor_Margin_Check_Pay
    ...
    End Sub
    Private Sub rg_check_sign_NeedDataSource(sender As Object, e As Telerik.Web.UI.GridNeedDataSourceEventArgs) Handles rg_check_pay.NeedDataSource
    ...
    Public Sub update_true(ByVal date_input As Date, ByVal iden As String)
        For Each item As GridDataItem In rg_check_pay.SelectedItems
            ...
            dao_det.fields.PAY_CHECK_DATE = date_input
            dao_det.update()
