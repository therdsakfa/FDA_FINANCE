Public Class Frm_Disburse_Debtor_Unlock_Pay_Insert
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            If Request.QueryString("bid") IsNot Nothing Then
                ...
                UC_Disburse_Debtor_Pay_Unlock_Detail1.getdata(dao)
            End If
        End If
    End Sub
    ...
    Private Sub btn_save_Click(sender As Object, e As EventArgs) Handles btn_save.Click
        Dim dao As New DAO_DISBURSE.TB_DEBTOR_BILL()
        dao.Getdata_by_DEBTOR_BILL_ID(Request.QueryString("bid"))
        UC_Disburse_Debtor_Pay_Unlock_Detail1.insert(dao)
        dao.fields.STATUS_ID = _stat
        dao.fields.GROUP_ID = _g
        dao.update()
        UC_Disburse_Debtor_Pay_Unlock_Detail1.insert_stat(_bid, _bt, _CLS.CITIZEN_ID_AUTHORIZE, _stat)
