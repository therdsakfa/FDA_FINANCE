Public Class Frm_Disburse_Debtor_Check_Number_Insert
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            If Request.QueryString("bid") IsNot Nothing Then
                ...
                UC_Disburse_Debtor_Check_Number_Detail1.getdata(dao)
            End If
        End If
    End Sub
    Private Sub btn_save_Click(sender As Object, e As EventArgs) Handles btn_save.Click
        ...
        'UC_Disburse_Debtor_Check_Number_Detail1.insert(dao)
        ...
        If _id_det <> "" Then
            ...
            For i As Integer = 0 To arr_det.Length - 1
                Try
                    ...
                    dao_det.Getdata_by_DEBTOR_BILL_DETAIL_ID(arr_det(i))
                    UC_Disburse_Debtor_Check_Number_Detail1.insert_det(dao_det)
                    dao_det.update()
                Catch ex As Exception
        ...
        'Dim dao_det As New DAO_DISBURSE.TB_DEBTOR_BILL_DETAIL
        'dao_det.Getdata_by_DEBTOR_BILL_ID(Request.QueryString("bid"))
        'UC_Disburse_Debtor_Check_Number_Detail1.insert_det(dao_det)
        'dao_det.update()
