<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Disburse_Debtor_No_Rebill_Bill_GFMIS.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_Debtor_No_Rebill_Bill_GFMIS" %>
<%@ Register src="../Disburse_Budget/UserControl/UC_Search_Form.ascx" tagname="UC_Search_Form" tagprefix="uc1" %>

<%@ Register src="../Disburse_Budget/UserControl/UC_Disburse_Budget_Bill.ascx" tagname="UC_Disburse_Budget_Bill" tagprefix="uc2" %>
...
<table width="100%">
        <tr>
            <td>
                ...
                <uc2:UC_Disburse_Budget_Bill ID="UC_Disburse_Budget_Bill1" runat="server" />
