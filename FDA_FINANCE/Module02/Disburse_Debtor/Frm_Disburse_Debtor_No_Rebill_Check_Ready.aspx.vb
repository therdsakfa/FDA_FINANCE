Public Class Frm_Disburse_Debtor_No_Rebill_Check_Ready
    ...
    Public Sub set_uc()
        ...
        UC_Disburse_Budget_PayType_Pass_Check_Ready1.g = 4
        UC_Disburse_Budget_PayType_Pass_Check_Ready1.is_no_rebill = True
    End Sub
