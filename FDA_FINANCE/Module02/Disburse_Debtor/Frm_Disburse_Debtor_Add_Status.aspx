<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Disburse_Debtor_Add_Status.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_Debtor_Add_Status" %>

<%@ Register src="../Disburse_Budget/UserControl/UC_Search_Form.ascx" tagname="UC_Search_Form" tagprefix="uc2" %>
<%@ Register src="UserControl/UC_Disburse_Debtor_Add_Status.ascx" tagname="UC_Disburse_Debtor_Add_Status" tagprefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="panel panel-body"  style="width:100%;">
                <h3><font color="black">ลูกหนี้เงินยืม งปม.</font></h3>
</div>
...
<table width="100%">
        ...
        <tr>
            <td>
                <uc1:UC_Disburse_Debtor_Add_Status ID="UC_Disburse_Debtor_Add_Status1" runat="server" />
            </td>
        </tr>
    </table>
    </div>
