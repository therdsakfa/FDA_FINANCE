<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Disburse_Debtor_Approve_Ok.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_Debtor_Approve_Ok" %>
...
<%@ Register src="UserControl/UC_Disburse_Debtor_Approve_Ok.ascx" tagname="UC_Disburse_Debtor_Approve_Ok" tagprefix="uc3" %>
    ...
    <table width="100%">
        ...
        <tr>
            <td>
                ...
                <uc3:UC_Disburse_Debtor_Approve_Ok ID="UC_Disburse_Debtor_Approve_Ok1" runat="server" />
