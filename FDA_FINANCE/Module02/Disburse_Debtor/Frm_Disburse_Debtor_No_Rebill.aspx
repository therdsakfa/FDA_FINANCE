<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Disburse_Debtor_No_Rebill.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_Debtor_No_Rebill" %>
...
<%@ Register src="UserControl/UC_Disburse_Debtor_No_Rebill.ascx" tagname="UC_Disburse_Debtor_No_Rebill" tagprefix="uc3" %>
        ...
        <script type="text/javascript" >
            $(document).ready(function () {
                ...
                $('#ctl00_ContentPlaceHolder1_btn_Add').click(function () {
                    ...
                    Popups('Frm_Disburse_Debtor_No_Rebill_Add.aspx?bgid=' + bgid.toString() + '&bgYear=' + bgYear.toString() + '&dept=' + select_dept.toString());
                    return false;
                });
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#ctl00_ContentPlaceHolder1_btn_Add').click(function () {
                ...
                openform("Frm_Disburse_Debtor_No_Rebill_Add.aspx?bgyear=" + bgYear, "#if1"); //ใส่ url, ID iframe
                return false;
            });
        });
        ...
        function k(id, bg_id, bgYear) {
            ...
            openform("../../Module02/Disburse_Budget/Frm_Disburse_Budget_Bill_edit.aspx?bid=" + id + "&bgid=" + bg_id + "&bgYear=" + bgYear, "#1234");
            return false;
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="panel panel-body"  style="width:100%;padding-left:5%;">
                <h3><font color="black">ลูกหนี้เงินทดรองไม่วางเบิก</font></h3>
</div>
...
<div class="panel panel-body"  style="width:100%;">
                <table width="100%">
                    ...
                    <tr>
                       ...
                       <uc3:UC_Disburse_Debtor_No_Rebill ID="UC_Disburse_Debtor_No_Rebill1" runat="server" />
        ...
        <div class="panel panel-info" style="width: 100%">
            <div class="panel-heading">
                <div class="modal-title text-center h1 ">
                    ดึงข้อมูล บค.ลูกหนี้ไม่วางเบิก
