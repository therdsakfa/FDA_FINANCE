Public Class Frm_Disburse_Debtor_Unlock_Deeka
    ...
    Public Sub set_uc()
        Try
            ...
            UC_Disburse_Debtor_Unlock_Deeka1.BudgetUseID = 1
            UC_Disburse_Debtor_Unlock_Deeka1.g = 1
    ...
    Protected Sub btn_approve_Click(sender As Object, e As EventArgs) Handles btn_approve.Click
        If rd_APPROVE_DATE.IsEmpty = False Then
            ...
            System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "alert('ปลดฎีกาเรียบร้อยแล้ว') ;", True)
            set_uc()
            UC_Disburse_Debtor_Unlock_Deeka1.rebind_grid()
        Else
    ...
    Private Sub btn_no_approve_Click(sender As Object, e As EventArgs) Handles btn_no_approve.Click
        UC_Disburse_Debtor_Unlock_Deeka1.update_false(11)
        System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "alert('ยกเลิกปลดฎีกาเรียบร้อยแล้ว') ;", True)
        set_uc()
        UC_Disburse_Debtor_Unlock_Deeka1.rebind_grid()
    End Sub
    'Protected Sub btn_approve_Click(sender As Object, e As EventArgs) Handles btn_approve.Click
    '    If rd_APPROVE_DATE.IsEmpty = False Then
    '        UC_Disburse_Debtor_Unlock_Deeka1.update_true(rd_APPROVE_DATE.SelectedDate)
    ...
    'Private Sub btn_no_approve_Click(sender As Object, e As EventArgs) Handles btn_no_approve.Click
    '    UC_Disburse_Debtor_Unlock_Deeka1.update_false()
