<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Disburse_Debtor_No_Rebill_Deeka_Number.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_Debtor_No_Rebill_Deeka_Number" %>
<%@ Register src="~/Module02/Disburse_Budget/UserControl/UC_Search_Form.ascx" tagname="UC_Search_Form" tagprefix="uc3" %>
<%@ Register src="~/Module02/Disburse_Budget/UserControl/UC_Disburse_Budget_Deeka_Number.ascx" tagname="UC_Disburse_Budget_Deeka_Number" tagprefix="uc1" %>
...
<table width="100%">
        <tr>
            <td >
                ...
                <uc1:UC_Disburse_Budget_Deeka_Number ID="UC_Disburse_Budget_Deeka_Number1" runat="server" />
            </td>
        </tr>
    </table>
 </div>   
