<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Disburse_Debtor_Bill.aspx.vb" Inherits="FDA_FINANCE.Frm_Disburse_Debtor_Bill" %>
<%@ Register src="../Disburse_Budget/UserControl/UC_Search_Form.ascx" tagname="UC_Search_Form" tagprefix="uc1" %>

<%@ Register src="UserControl/UC_Disburse_Debtor_Bill.ascx" tagname="UC_Disburse_Debtor_Bill" tagprefix="uc2" %>
...
<table width="100%">
        <tr>
            <td>
                ...
                <uc2:UC_Disburse_Debtor_Bill ID="UC_Disburse_Debtor_Bill1" runat="server" />
