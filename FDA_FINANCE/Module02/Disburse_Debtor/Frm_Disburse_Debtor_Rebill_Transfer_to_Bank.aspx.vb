Public Class Frm_Disburse_Debtor_Rebill_Transfer_to_Bank
    ...
    Public Sub set_uc()
        ...
        UC_Disburse_Budget_Transfer_to_Customer1.g = 3
        UC_Disburse_Budget_Transfer_to_Customer1.is_rebill = True
    End Sub
