...
Public Class UC_Disburse_Budget_withdraw_deka_add
    ...
    Public Sub insert(ByRef dao As DAO_DISBURSE.TB_BUDGET_WITHDRAW_DEKA)
        ...
        dao.fields.DekaBillNumber = deka_bill.Value
        dao.fields.FK_ID = fk_bill.Value

        If txt_wd_date.Text <> "" Then
            dao.fields.DateDeka = CDate(txt_wd_date.Text)
        Else
        ...
        dao.fields.NameAccBank = txt_nameAccBank.Text
        dao.fields.NumBank = num_bank.Text

        Try
            dao.fields.AmountW = rnt_amount.Value
        Catch ex As Exception
            dao.fields.AmountW = 0
        End Try
        Try
            dao.fields.Vat1 = rnt_vat.Value
        Catch ex As Exception
            dao.fields.Vat1 = 0
        End Try
        Try
            dao.fields.Vat2 = rnt_vat2.Value
        Catch ex As Exception
            dao.fields.Vat2 = 0
        End Try
        Try
            dao.fields.Mulct = rnt_mulct.Value
        Catch ex As Exception
            dao.fields.Mulct = 0
        End Try
        Try
            dao.fields.AmountInCome = rnt_AmountIncome.Value
        Catch ex As Exception
            dao.fields.AmountInCome = 0
        End Try
    ...
    Public Sub get_data(ByRef dao As DAO_DISBURSE.TB_BUDGET_BILL)
        ...
        fk_bill.Value = dao.fields.BUDGET_DISBURSE_BILL_ID
