<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Report_R2_017.aspx.vb" Inherits="FDA_FINANCE.Frm_Report_R2_017" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table>
        <tr>
            <td>รายงานการโอน/ใช้หนี้เงินทดรองราชการ</td>
        </tr>
        <tr>
            <td>
