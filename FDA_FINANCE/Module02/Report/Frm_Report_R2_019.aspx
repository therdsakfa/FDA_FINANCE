<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Report_R2_019.aspx.vb" Inherits="FDA_FINANCE.Frm_Report_R2_019" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table>
        <tr>
            <td>รายงานทะเบียนคุมรายการเบิก/จ่าย (ทะเบียน3)กรณีจ่ายตรงวันที่ บก. เบิก</td>
        </tr>
        <tr>
            <td>
