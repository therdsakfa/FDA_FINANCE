Public Class Frm_Report_R2_017
    ...
    Public Function getReportData()
        ...
        Dim dt As DataTable = bao.getReportData_R2_017(UC_Report_SelectDate_Single.dateSelect) 'ส่ง Parameter วันที่ต้องการดูรายงานเข้าไป
    ...
    Private Sub btn_ShowReport_Click(sender As Object, e As EventArgs) Handles btn_ShowReport.Click
        ...
        util.ShowReport(ReportViewer1, util.root & "Module02\Report_R2_017.rdlc", "Fields_Report_R2_017", getReportData())
    End Sub
End Class