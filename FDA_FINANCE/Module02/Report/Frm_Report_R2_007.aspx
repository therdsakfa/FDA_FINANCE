<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Report_R2_007.aspx.vb" Inherits="FDA_FINANCE.Frm_Report_R2_007" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table>
        <tr>
            <td>รายงานทะเบียนคุมลูกหนี้รายตัว (เงินงบประมาณ)</td>
        </tr>
        <tr>
            <td>
              ปีงบประมาณ  &nbsp;<asp:DropDownList ID="dd_BudgetYear" runat="server" Width="100px" DataTextField="byear" DataValueField="byear" AutoPostBack="true">
                ...
                <uc1:UC_Report_SelectUser_NAME_AD_NAME runat="server" id="UC_Report_SelectUser_NAME_AD_NAME" />
            </td>
            <td>
