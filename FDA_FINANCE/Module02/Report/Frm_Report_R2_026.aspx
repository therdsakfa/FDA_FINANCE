<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Report_R2_026.aspx.vb" Inherits="FDA_FINANCE.Frm_Report_R2_026" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table>
        <tr>
            <td>รายงานข้อมูลส่งใช้หนี้เงินยืมงบประมาณ ที่ส่งเงินสดเกิน 25%</td>
        </tr>
        <tr>
            <td>
