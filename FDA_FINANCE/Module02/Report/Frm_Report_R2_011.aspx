<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Report_R2_011.aspx.vb" Inherits="FDA_FINANCE.Frm_Report_R2_011" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table>
        <tr>
            <td>รายงานลูกหนี้เงินยืม ที่วางเบิกจากระบบ GFMIS แล้ว(แต่ยังไม่จ่าย)</td>
        </tr>
        <tr>
            <td>
