<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Report_R2_005.aspx.vb" Inherits="FDA_FINANCE.Frm_Report_R2_005" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table>
        <tr>
            <td>รายงานสถานะลูกหนี้ (เงินงบประมาณ)</td>
        </tr>
        <tr>
            <td>
