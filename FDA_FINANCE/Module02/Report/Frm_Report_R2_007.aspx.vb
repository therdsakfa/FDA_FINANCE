Public Class Frm_Report_R2_007
    ...
    Public Function getReportData()
        ...
        UC_Report_SelectUser_NAME_AD_NAME.getAD_Name()
        Dim dt As DataTable = bao.getReportData_R2_007(UC_Report_SelectUser_NAME_AD_NAME.adName, dd_BudgetYear.SelectedValue) 'ส่ง Parameter วันที่ต้องการดูรายงานเข้าไป
    ...
    Private Sub btn_ShowReport_Click(sender As Object, e As EventArgs) Handles btn_ShowReport.Click
        ...
        util.ShowReport(ReportViewer1, util.root & "Module02\Report_R2_007.rdlc", "Fields_Report_R2_007", getReportData())
    End Sub
End Class