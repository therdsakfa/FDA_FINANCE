Public Class Frm_Report_R2_008
    ...
    Public Function getReportData()
        ...
        UC_Report_SelectUser_NAME_AD_NAME1.getAD_Name()
        Dim dt As DataTable = bao.getReportData_R2_008(UC_Report_SelectUser_NAME_AD_NAME1.adName, dd_BudgetYear.SelectedValue) 'ส่ง Parameter วันที่ต้องการดูรายงานเข้าไป
    ...
    Private Sub btn_ShowReport_Click(sender As Object, e As EventArgs) Handles btn_ShowReport.Click
        ...
        util.ShowReport(ReportViewer1, util.root & "Module02\Report_R2_008.rdlc", "Fields_Report_R2_008", getReportData())
    End Sub
End Class