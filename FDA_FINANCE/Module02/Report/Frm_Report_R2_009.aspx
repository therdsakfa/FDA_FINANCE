<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Report_R2_009.aspx.vb" Inherits="FDA_FINANCE.Frm_Report_R2_009" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table>
        <tr>
            <td>รายงานลูกหนี้เงินยืม(คงเหลือ) ณ วันที่ (เงินงบประมาณ)</td>
        </tr>
        <tr>
            <td>
