Public Class Frm_Budget_Transfer_Receive_Insert
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            UC_Budget_Transfer_Receive_Detail1.set_date()
            ...
            UC_Budget_Transfer_Receive_Detail1.bind_sub_bg2_insert()
            UC_Budget_Transfer_Receive_Detail1.set_hide_unhide2()
    ...
    Protected Sub btn_save_Click(sender As Object, e As EventArgs) Handles btn_save.Click
        ...
        UC_Budget_Transfer_Receive_Detail1.insert(dao)
        dao.insert()
