<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node_User.Master" CodeBehind="Frm_Budget_Transfer_Receive_User.aspx.vb" Inherits="FDA_FINANCE.Frm_Budget_Transfer_Receive_User" %>
<%@ Register src="UserControl/UC_Budget_Transfer_Receive.ascx" tagname="UC_Budget_Transfer_Receive" tagprefix="uc1" %>
    ...
    <%--<script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#ctl00_ContentPlaceHolder1_btn_Add').click(function () {
                ...
                openform("Frm_Budget_Transfer_Receive_Insert.aspx?bgYear=" + bgYear, "#if1"); //ใส่ url, ID iframe
                return false;
            });
        });
    ...
    <script type="text/javascript" >
        $(document).ready(function () {
            ...
            $('#ctl00_ContentPlaceHolder1_btn_Add').click(function () {
                ...
                Popups('Frm_Budget_Transfer_Receive_User_Insert.aspx?bgid=' + bgid.toString() + '&bgYear=' + bgYear.toString() + '&dept=' + select_dept.toString());
                return false;
            });
...
<div class="panel panel-body"  style="width:100%;">
    <h3>รับโอนจากหน่วยงานภายนอกกรม</h3>
    </div>
<div class="panel panel-body"  style="width:100%;">
        <table>
            <tr>
        ...
        <tr>
            <td>
               ...
               <asp:Button ID="btnRedirect" runat="server" Text="Button" Style="display:none;" />
                ...
                <uc1:UC_Budget_Transfer_Receive ID="UC_Budget_Transfer_Receive1" runat="server" />
    ...
    <iframe id="if1" width="1000px" height="700px" ></iframe>
        ...
        <div class="panel panel-info" style="width: 100%">
            <div class="panel-heading">
                <div class="modal-title text-center h1 ">
                    บันทึกการรับโอนจากหน่วยงานภายนอกกรม
     ...
     <div class="modal fade" id="myModal2">
        <div class="panel panel-info" style="width: 100%">
            <div class="panel-heading">
                <div class="modal-title text-center h1 ">
                    แก้ไขการรับโอนจากหน่วยงานภายนอกกรม
                    <button type="button" class="btn btn-default pull-right" data-dismiss="modal">ปิดหน้าต่าง</button>
                </div>
                <div class="panel-body panel-info" style="width: 100%">
