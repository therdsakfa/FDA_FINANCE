Public Class Frm_Report_R1_024
    ...
    Public Function getReportData() As DataTable
        ...
        Dim dt As DataTable = bao.getReportData_R1_024(UC_Report_SelectDate_Between1.dateBegin, UC_Report_SelectDate_Between1.dateEnd, UC_Report_Dept_Plan1.dept)
    ...
    Private Sub btn_ShowReport_Click(sender As Object, e As EventArgs) Handles btn_ShowReport.Click
        ...
        util.ShowReport(ReportViewer1, util.root & "Module01\Report_R1_024.rdlc", "Fields_Report_R1_024", getReportData())
    End Sub
End Class