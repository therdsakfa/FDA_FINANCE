<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Report_R1_023.aspx.vb" Inherits="FDA_FINANCE.Frm_Report_R1_023" %>
...
<%@ Register Src="~/Module09/UserControl/UC_Report_Dept_Budget_Adjust.ascx" TagPrefix="uc1" TagName="UC_Report_Dept_Budget_Adjust" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table>
        <tr>
            <td>
                <uc1:UC_Report_SelectDate_Between runat="server" ID="UC_Report_SelectDate_Between2" />
                <uc1:UC_Report_Dept_Budget_Adjust runat="server" ID="UC_Report_Dept_Budget_Adjust1" />
                <table>
                    <tr>
                        <td>ปีงบประมาณ :</td>
