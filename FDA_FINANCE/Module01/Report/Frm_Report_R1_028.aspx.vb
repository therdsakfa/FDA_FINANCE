Public Class Frm_Report_R1_028
    ...
    Public Function getReportData()
        ...
        Dim dt As New DataTable
        dt = bao.get_Report_R1_028(UC_Report_SelectDate_Between1.dateBegin, UC_Report_SelectDate_Between1.dateEnd, dd_BudgetYear.SelectedValue)
    ...
    Private Sub btn_ShowReport_Click(sender As Object, e As EventArgs) Handles btn_ShowReport.Click
        ...
        util.ShowReport(ReportViewer1, util.root & "Module01\Report_R1_028.rdlc", "Fields_Report_R1_028", getReportData())
    End Sub
End Class