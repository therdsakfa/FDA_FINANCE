<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Report_R1_002.aspx.vb" Inherits="FDA_FINANCE.Frm_Report_R1_002" %>
...
<%@ Register Src="../../Module09/UserControl/UC_Report_Dept_Budget_Adjust.ascx" TagPrefix="uc2" TagName="UC_Report_Dept_Budget_Adjust" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table>
         <tr>
            <td>รายงานทะเบียนคุมย่อย รง.2</td>
        </tr>
        <tr>
            <td>
                ...
                <%--<uc2:UC_Report_Dept_Budget_Adjust runat="server" ID="UC_Report_Dept_Budget_Adjust1" />--%>
            </td>
            <td valign="top">
