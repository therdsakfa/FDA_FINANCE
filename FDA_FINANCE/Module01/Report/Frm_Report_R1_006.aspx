<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Report_R1_006.aspx.vb" Inherits="FDA_FINANCE.Frm_Report_R1_006" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <table>
         <tr>
            <td>รายงานการใช้จ่ายเงินแบ่งตามกอง รง.5</td>
        </tr>
        <tr>
            <td>
