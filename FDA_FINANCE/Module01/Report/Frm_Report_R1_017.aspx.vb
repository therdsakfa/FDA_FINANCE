Public Class Frm_Report_R1_017
    ...
    Public Function getReportData() As DataTable
        ...
        dt = bao.getReportData_R1_017(UC_Report_SelectDate_Between1.dateBegin, UC_Report_SelectDate_Between1.dateEnd, UC_Report_Dept_Budget_Adjust1.bg_id)
    ...
    Private Sub btn_ShowReport_Click(sender As Object, e As EventArgs) Handles btn_ShowReport.Click
        ...
        util.ShowReport(ReportViewer1, util.root & "Module01\Report_R1_017.rdlc", "Fields_Report_R1_017", getReportData())
    End Sub
End Class