Public Class Frm_Report_R1_008
    ...
    Public Function getReportData() As DataTable
        ...
        Dim dt As DataTable = bao.getReportData_R1_008(UC_Report_SelectDate_Between1.dateBegin, UC_Report_SelectDate_Between1.dateEnd, UC_Report_Dept_Plan1.dept)
        dt.Columns.Add("plan")
        ...
        For Each dr As DataRow In dt.Rows
            ...
            po = bao_po.getReportData_R1_007_po(UC_Report_SelectDate_Between1.dateBegin, UC_Report_SelectDate_Between1.dateEnd, dr("BUDGET_PLAN_ID"))
            burse = bao_burse.getReportData_R1_007_burse(UC_Report_SelectDate_Between1.dateBegin, UC_Report_SelectDate_Between1.dateEnd, dr("BUDGET_PLAN_ID"))
            borrowmoney = bao.getReportData_R1_007_moneyborrow(UC_Report_SelectDate_Between1.dateBegin, UC_Report_SelectDate_Between1.dateEnd, dr("BUDGET_PLAN_ID"))
    ...
    Private Sub btn_ShowReport_Click(sender As Object, e As EventArgs) Handles btn_ShowReport.Click
        ...
        util.ShowReport(ReportViewer1, util.root & "Module01\Report_R1_008.rdlc", "Fields_Report_R1_008", getReportData())
    End Sub
End Class