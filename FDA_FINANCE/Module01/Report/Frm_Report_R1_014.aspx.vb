Public Class Frm_Report_R1_014
    ...
    Public Function getReportData() As DataTable
        ...
        Dim dt As DataTable = bao.getReportData_R1_014(UC_Report_SelectDate_Between1.dateBegin, UC_Report_SelectDate_Between1.dateEnd, UC_Report_Dept_Budget_Adjust1.dept)
        dt.Columns.Add("projectoractivity")
        For Each dr As DataRow In dt.Rows
            dr("projectoractivity") = get_bg(dr("BUDGET_PLAN_ID"), 5)
        Next
    ...
    Protected Sub btn_ShowReport_Click(sender As Object, e As EventArgs) Handles btn_ShowReport.Click
        ...
        util.ShowReport(ReportViewer1, util.root & "Module01\Report_R1_014.rdlc", "Fields_Report_R1_014", getReportData())
    End Sub
