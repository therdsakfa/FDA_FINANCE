Public Class Frm_Report_R1_012
    ...
    Public Function getReportData() As DataTable
        ...
        Dim dt As DataTable = bao.getReportData_R1_012(UC_Report_SelectDate_Between1.dateBegin, UC_Report_SelectDate_Between1.dateEnd, UC_Report_Dept_Budget_Adjust1.dept)
        dt.Columns.Add("project")
       
        For Each dr As DataRow In dt.Rows
            dr("project") = get_bg(dr("BUDGET_PLAN_ID"))
    ...
    Public Function get_bg(bg_id As Integer) As String
        ...
        For Each dr_node As DataRow In dt_node.Rows
            If IsDBNull(dr_node("BUDGET_TYPE_ID")) = False Then
                If CInt(dr_node("BUDGET_TYPE_ID")) = 5 Then
    ...
    Private Sub btn_ShowReport_Click(sender As Object, e As EventArgs) Handles btn_ShowReport.Click
        ...
        util.ShowReport(ReportViewer1, util.root & "Module01\Report_R1_012.rdlc", "Fields_Report_R1_012", getReportData())
    End Sub
End Class