Imports System.Linq
Public Class Frm_Report_R1_006
    ...
    Public Function getReportData() As DataTable
        ...
        Dim dt As DataTable = bao.getReportData_R1_006(UC_Report_SelectDate_Between1.dateBegin, UC_Report_SelectDate_Between1.dateEnd, UC_Report_Dept1.dept)
        dt.Columns.Add("plan")
        ...
        For Each dr As DataRow In dt.Rows
            ...
            ' transfer = bao_transfer.getReportData_R1_004_transfer(UC_Report_SelectDate_Between1.dateBegin, UC_Report_SelectDate_Between1.dateEnd, dr("BUDGET_PLAN_ID"))
            'diff = bao_diff.getReportData_R1_004_diff(UC_Report_SelectDate_Between1.dateBegin, UC_Report_SelectDate_Between1.dateEnd, dr("BUDGET_PLAN_ID"))
            po = bao_po.getReportData_R1_006_po(UC_Report_SelectDate_Between1.dateBegin, UC_Report_SelectDate_Between1.dateEnd, dr("BUDGET_PLAN_ID"))
            burse = bao_burse.getReportData_R1_006_burse(UC_Report_SelectDate_Between1.dateBegin, UC_Report_SelectDate_Between1.dateEnd, dr("BUDGET_PLAN_ID"))
            borrowmoney = bao.getReportData_R1_006_moneyborrow(UC_Report_SelectDate_Between1.dateBegin, UC_Report_SelectDate_Between1.dateEnd, dr("BUDGET_PLAN_ID"))
    ...
    Public Function getReportData_New() As DataTable
        ...
        UC_Report_Dept1.get_dept_select()
        Dim bao As New BAO_BUDGET.Report
        Dim dt As DataTable = bao.get_Report_R1_006_1(UC_Report_SelectDate_Between1.dateBegin, UC_Report_SelectDate_Between1.dateEnd, UC_Report_Dept1.dept, dd_BudgetYear.SelectedValue)
        dt.Columns.Add("plan")
        dt.Columns.Add("paybudget")
        For Each dr As DataRow In dt.Rows
            dr("plan") = get_group(dr("BUDGET_PLAN_ID"))
    ...
    Public Sub run_report()
        ...
        util.ShowReport(ReportViewer1, util.root & "Module01\Report_R1_006.rdlc", "Fields_Report_R1_006", getReportData_New())
    End Sub
