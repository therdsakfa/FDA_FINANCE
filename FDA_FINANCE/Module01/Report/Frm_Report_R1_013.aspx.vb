Public Class Frm_Report_R1_013
    ...
    Public Function getReportData() As DataTable
        ...
        Dim dt As DataTable = bao.getReportData_R1_013(UC_Report_SelectDate_Between1.dateBegin, UC_Report_SelectDate_Between1.dateEnd)
        dt.Columns.Add("plan")

        For Each dr As DataRow In dt.Rows
            dr("plan") = get_bg(dr("BUDGET_PLAN_ID"))
    ...
    Protected Sub btn_ShowReport_Click(sender As Object, e As EventArgs) Handles btn_ShowReport.Click
        ...
        util.ShowReport(ReportViewer1, util.root & "Module01\Report_R1_013.rdlc", "Fields_Report_R1_013", getReportData())
    End Sub
End Class