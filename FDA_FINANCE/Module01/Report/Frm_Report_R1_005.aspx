<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Report_R1_005.aspx.vb" Inherits="FDA_FINANCE.Frm_Report_R1_005" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table>
        <tr>
            <td>รายงานยอดรวมแบ่งตามกอง รง.4</td>
        </tr>
        <tr>
            <td>
