<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Report_R1_007.aspx.vb" Inherits="FDA_FINANCE.Frm_Report_R1_007" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <table>
         <tr>
            <td>รายงานการใช้จ่ายเงิน รง.6</td>
        </tr>
        <tr>
            <td>
