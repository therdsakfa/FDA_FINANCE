Public Class Frm_Report_R1_016
    ...
    Public Function getReportData() As DataTable
        ...
        Dim dt_period As DataTable = bao_period.get_Report_R1_Period(UC_Report_SelectDate_Between1.dateBegin, UC_Report_SelectDate_Between1.dateEnd, UC_Report_Dept_Budget_Adjust1.bg_id, dd_BudgetYear.SelectedValue)
        ...
        dt = bao.getReportData_R1_016(UC_Report_SelectDate_Between1.dateBegin, UC_Report_SelectDate_Between1.dateEnd, UC_Report_Dept_Budget_Adjust1.bg_id)
    ...
    Private Sub btn_ShowReport_Click(sender As Object, e As EventArgs) Handles btn_ShowReport.Click
        ...
        util.ShowReport(ReportViewer1, util.root & "Module01\Report_R1_016.rdlc", "Fields_Report_R1_016", getReportData())
    End Sub
End Class