Public Class Frm_Report_R1_001_1
    ...
    Public Function getReportData() As DataTable
        ...
        dt = bao.get_Report_R1_001_TEST(UC_Report_SelectDate_Between1.dateBegin, UC_Report_SelectDate_Between1.dateEnd, UC_Report_Dept_Budget_Adjust_Sub1.bg_id, UC_Report_Dept_Budget_Adjust_Sub1.bgyear)
        ...
        If dt.Rows.Count > 0 Then
            ...
            '    adjust = dt(0)("adjust_amount")
            'End If
            'If IsDBNull(dt(0)("transfer_amount")) = False Then
            '    transfer_amount = dt(0)("transfer_amount")
            'End If
            'If IsDBNull(dt(0)("change_amount")) = False Then
            '    change_amount = dt(0)("change_amount")
            'End If
    ...
    'Public Function getReportData_Support() As DataTable
    '    Dim bao As New BAO_BUDGET.Report
    '    UC_Report_SelectDate_Between1.getDateSelect()
    ...
    '    For Each dr_p1 As DataRow In dt_period.Rows
    '        Dim dt As New DataTable
    '        dt = bao.get_Report_R1_001_support(UC_Report_SelectDate_Between1.dateBegin, UC_Report_SelectDate_Between1.dateEnd, dr_p1("PATLIST_ID"))
    '        dt.Columns.Add("balance", Type.GetType("System.Double"))
    '        dt.Columns.Add("parambudgetplan")
    '        dt.Columns.Add("billdate")
    '        dt_period.Merge(dt)
    '        'Dim dv_period As DataView = dt_period.DefaultView
    '        'dv_period.Sort = "PATLIST_ID ASC"
    '        'dt_period = dv_period.ToTable
