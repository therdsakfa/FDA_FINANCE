Public Class Frm_Report_R1_002
    ...
    '    dt = bao.getReportData_R1_002(UC_Report_SelectDate_Between1.dateBegin, UC_Report_SelectDate_Between1.dateEnd, UC_Report_Dept_Budget_Adjust1.bg_id)
    ...
    Public Function getReportData_NEW() As DataTable
        ...
        Dim dt As New DataTable
        dt = bao.get_Report_R1_002_1(UC_Report_SelectDate_Between1.dateBegin, UC_Report_SelectDate_Between1.dateEnd, UC_Report_Dept_Budget_Adjust_Sub1.bg_id, UC_Report_Dept_Budget_Adjust_Sub1.bgyear)
        dt.Columns.Add("balance", Type.GetType("System.Double"))
        dt.Columns.Add("parambudgetplan")
        dt.Columns.Add("billdate")
        ...
        Return dt_period
    End Function
    Public Function getReportData_NEW2() As DataTable
        Dim bao As New BAO_BUDGET.Report
        UC_Report_SelectDate_Between1.getDateSelect()
        UC_Report_Dept_Budget_Adjust_Sub1.get_dataselect() '
        ...
        If dt_period.Rows.Count > 0 Then
            ...
            End If
            Dim dv1 As DataView = dt_period.DefaultView
            dv1.Sort = "DOC_DATE"

            dt_period = dv1.ToTable
    ...
    Public Function getReportData_sup() As DataTable
        ...
        For Each dr_p As DataRow In dt_sup_bg_key.Rows
            Dim dt As New DataTable
            dt = bao.get_Report_R1_002_support(UC_Report_SelectDate_Between1.dateBegin, UC_Report_SelectDate_Between1.dateEnd, dr_p("BUDGET_PLAN_ID"), UC_Report_Dept_Budget_Adjust_Sub1.bgyear)
            dt.Columns.Add("balance", Type.GetType("System.Double"))
            dt.Columns.Add("parambudgetplan")
            dt.Columns.Add("billdate")
            ' dt_period.Merge(dt)
    ...
    Public Function getReportData_sup_Only() As DataTable
        ...
        'For Each dr_p As DataRow In dt_sup_bg_key.Rows
        Dim dt As New DataTable
        dt = bao.get_Report_R1_002_support(UC_Report_SelectDate_Between1.dateBegin, UC_Report_SelectDate_Between1.dateEnd, UC_Report_Dept_Budget_Adjust_Sub1.sub_bg, UC_Report_Dept_Budget_Adjust_Sub1.bgyear)
        dt.Columns.Add("balance", Type.GetType("System.Double"))
        dt.Columns.Add("parambudgetplan")
        dt.Columns.Add("billdate")
        ' dt_period.Merge(dt)
    ...
    Private Sub btn_ShowReport_Click(sender As Object, e As EventArgs) Handles btn_ShowReport.Click
        ...
        '        util.ShowReport(ReportViewer1, util.root & "Module01\Report_R1_002_sup.rdlc", "Fields_Report_R1_001", getReportData_sup())
        '    Else
        '        util.ShowReport(ReportViewer1, util.root & "Module01\Report_R1_002.rdlc", "Fields_Report_R1_002", getReportData_NEW())
        '    End If
    ...
    Public Sub run_report()
        ...
        If dao.fields.BUDGET_IS_SUPPORT_DEPT = True Then
            If UC_Report_Dept_Budget_Adjust_Sub1.sub_bg = 0 Then
                util.ShowReport(ReportViewer1, util.root & "Module01\Report_R1_002_sup.rdlc", "Fields_Report_R1_001", getReportData_sup())
            Else
                util.ShowReport(ReportViewer1, util.root & "Module01\Report_R1_002_sup.rdlc", "Fields_Report_R1_001", getReportData_sup_Only())
            End If

        Else
            util.ShowReport(ReportViewer1, util.root & "Module01\Report_R1_002.rdlc", "Fields_Report_R1_002", getReportData_NEW2())
        End If
