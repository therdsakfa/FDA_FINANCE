<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Budget_Transfer_Share_Type_Edit.aspx.vb" Inherits="FDA_FINANCE.Frm_Budget_Transfer_Share_Type_Edit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <asp:Panel ID="Panel1" runat="server" GroupingText="แก้ไขการโอน">
    <table>
    <tr>
            <td>
        ...
        <tr>
        <td>
        <asp:Button ID="btn_save" runat="server" Text="แก้ไขการโอน" />
        </td>
