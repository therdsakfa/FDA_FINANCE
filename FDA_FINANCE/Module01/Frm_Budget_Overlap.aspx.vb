Public Class Frm_Budget_Overlap
    ...
    Public Sub set_uc()
        UC_Budget_Overlap1.dept_id = dd_Department.SelectedValue
        UC_Budget_Overlap1.bdid = dd_BudgetAdjust.SelectedValue
        ...
        UC_Budget_Overlap1.BudgetYear = Master.get_Year
    End Sub
    ...
    Protected Sub btn_Add_Click(sender As Object, e As EventArgs) Handles btn_Add.Click
        Response.Redirect("Frm_Budget_Overlap_Insert.aspx?bgid=" & dd_BudgetAdjust.SelectedValue & "&bgYear=" & Master.get_Year() & "type=" & 1)
    End Sub

    Private Sub btn_Add_bill_Click(sender As Object, e As EventArgs) Handles btn_Add_bill.Click
        Response.Redirect("Frm_Budget_Overlap_Bill.aspx")
    End Sub

    Private Sub btn_Add_debtor_Click(sender As Object, e As EventArgs) Handles btn_Add_debtor.Click
        Response.Redirect("Frm_Budget_Overlap_Debtor.aspx")
    End Sub

    Private Sub Frm_Budget_Overlap_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        UC_Budget_Overlap1.bindseq()
    End Sub
    ...
    Private Sub dd_Department_SelectedIndexChanged(sender As Object, e As EventArgs) Handles dd_Department.SelectedIndexChanged
        bind_dl_bg()
        set_uc()
        UC_Budget_Overlap1.rebind_grid()
    End Sub
