Public Class Frm_Budget_Overlap_Approve_Cancel
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            End If
        End If
        UC_Budget_Overlap_Approve_Cancel1.BudgetID = dd_BudgetAdjust.SelectedValue
        UC_Budget_Overlap_Approve_Cancel1.Budgetyear = bgYear
