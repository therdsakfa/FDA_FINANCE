<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UC_Budget_Transfer_In_User_Detail.ascx.vb" Inherits="FDA_FINANCE.UC_Budget_Transfer_In_User_Detail" %>
...
<table width="100%">
    ...
    <tr>
     ...
     <tr>
        ...
        <td>
            ...
            <asp:DropDownList ID="dd_BudgetAdjust" runat="server" AutoPostBack="true" class="ddl" DataTextField="BUDGET_DESCRIPTION" DataValueField="BUDGET_PLAN_ID" Width="200px">
            </asp:DropDownList>
    ...
    <tr>
        ...
        <td>
            <asp:DropDownList ID="dd_bg_adjust_receive" runat="server" DataTextField="BUDGET_DESCRIPTION" DataValueField="BUDGET_PLAN_ID" AutoPostBack="true" Width="200px">
