Public Class UC_Budget_Transfer_In_User_Detail
    ...
    Public Sub set_edit()
        If Request.QueryString("id") IsNot Nothing Then
            ...
            If dao.fields.FROM_DEPARTMENT_ID IsNot Nothing Then
                ...
                dao_d.Getdata_by_DEPARTMENT_ID(dao.fields.FROM_DEPARTMENT_ID)

                lb_dept.Text = dao_d.fields.DEPARTMENT_DESCRIPTION
            End If
    ...
    Public Sub set_lb()
        ...
        dao.Getdata_by_DEPARTMENT_ID(Request.QueryString("dept"))
    ...
    Public Sub bind_sub_bg2_insert()
        Dim bao As New BAO_BUDGET.MASS
        Dim dt As DataTable = bao.get_sub_bg(dd_bg_adjust_receive.SelectedValue)
        dd_sub_bg2.DataSource = dt
        dd_sub_bg2.DataBind()
    ...
    Public Sub bind_dl_bg()
        ...
        Dim dt As DataTable = bao_adjust.get_bg_adjust_by_dept_year(dept, Request.QueryString("bgYear"))
    ...
    Public Sub insert(ByRef dao As DAO_BUDGET.TB_BUDGET_TRANSFER)
        Try
            ...
            dao.fields.FROM_DEPARTMENT_ID = dept
    ...
    Public Sub set_hide_unhide2()
        Dim bao As New BAO_BUDGET.MASS
        Dim bool As Boolean = bao.get_support_dept_type(dd_bg_adjust_receive.SelectedValue)
        If bool = False Then
            lb_sub_bg2.Style.Add("display", "none")
            dd_sub_bg2.Style.Add("display", "none")
        Else
