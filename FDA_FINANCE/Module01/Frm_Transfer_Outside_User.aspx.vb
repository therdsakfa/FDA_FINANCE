Public Class Frm_Transfer_Outside_User
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        End Try
        runQuery()
        UC_Budget_Transfer_Out1.user = "1"
        UC_Budget_Transfer_Out1.bgyear = bgYear
        UC_Budget_Transfer_Out1.dept_id = _dept
    End Sub
    Private Sub btnRedirect_Click(sender As Object, e As EventArgs) Handles btnRedirect.Click
        UC_Budget_Transfer_Out1.rg_rebind()
    End Sub

    Protected Sub btn_search_Click(sender As Object, e As EventArgs) Handles btn_search.Click
        Dim strMsg As String = ""
        strMsg = UC_Budget_Search_Form1.getSearchMsg()
        UC_Budget_Transfer_Out1.rgFilter(strMsg)
    End Sub
End Class