<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Transfer_Inside.aspx.vb" Inherits="FDA_FINANCE.Frm_Transfer_Inside" %>
    ...
    <script type="text/javascript" >
        $(document).ready(function () {
            ...
            $('#ctl00_ContentPlaceHolder1_btn_Add').click(function () {
                ...
                Popups('Frm_Budget_Transfer_In_insert.aspx?bgid=' + bgid.toString() + '&bgYear=' + bgYear.toString() + '&dept=' + select_dept.toString());
                return false;
            });
