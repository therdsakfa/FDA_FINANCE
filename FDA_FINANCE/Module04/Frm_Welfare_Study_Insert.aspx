<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Welfare_Study_Insert.aspx.vb" Inherits="FDA_FINANCE.Frm_Welfare_Study_Insert" %>

<%@ Register Src="~/Module04/UseControl/UC_Welfare_Study_Detail.ascx" TagPrefix="uc1" TagName="UC_Welfare_Study_Detail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            showdate($("#ctl00_ContentPlaceHolder1_UC_Welfare_Study_Detail_txt_WELFARE_DATE"));
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <tr>
            <td>
                <uc1:UC_Welfare_Study_Detail runat="server" id="UC_Welfare_Study_Detail" />
            </td>
        </tr>
        <tr>
            <td align="center">
