<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UC_Welfare_Cure_Detail.ascx.vb" Inherits="FDA_FINANCE.UC_Welfare_Cure_Detail" %>
<table>
    <tr>
        <td align="right">รายละเอียดค่ารักษา : </td>
        <td>
