Public Class Frm_Report_R4_001
    ...
    Public Function getReportData()
        ...
        If dd_month.SelectedValue = "" Then
            dt = bao.get_Report_R4_001_all_month(dd_BudgetYear.SelectedValue)
        Else
            dt = bao.getReportData_R4_001(dd_month.SelectedValue, dd_BudgetYear.SelectedValue)
        End If
    ...
    Private Sub btn_ShowReport_Click(sender As Object, e As EventArgs) Handles btn_ShowReport.Click
        ...
        util.ShowReport(ReportViewer1, util.root & "Module04\Report_R4_001.rdlc", "Fields_Report_R4_001", getReportData())
    End Sub
