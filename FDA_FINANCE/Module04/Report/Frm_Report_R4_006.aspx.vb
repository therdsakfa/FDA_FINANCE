Public Class Frm_Report_R4_006
    ...
    Public Function getReportData()
        ...
        Dim dt As DataTable = bao.get_Report_R4_006_1(dd_month.SelectedValue, dd_BudgetYear.SelectedValue)
    ...
    Private Sub btn_ShowReport_Click(sender As Object, e As EventArgs) Handles btn_ShowReport.Click
        ...
        util.ShowReport(ReportViewer1, util.root & "Module04\Report_R4_006.rdlc", "Fields_Report_R4_006", getReportData())
    End Sub
