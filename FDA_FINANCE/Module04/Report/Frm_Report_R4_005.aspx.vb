Public Class Frm_Report_R4_005
    ...
    Public Function getReportData()
        ...
        If dd_month.SelectedValue = "" Then
            dt = bao.get_Report_R4_005_1_all(dd_BudgetYear.SelectedValue)
        Else
            dt = bao.get_Report_R4_005_1(dd_BudgetYear.SelectedValue, dd_month.SelectedValue)
        End If
    ...
    Private Sub btn_ShowReport_Click(sender As Object, e As EventArgs) Handles btn_ShowReport.Click
        ...
        util.ShowReport(ReportViewer1, util.root & "Module04\Report_R4_005.rdlc", "Fields_Report_R4_005", getReportData())
    End Sub
