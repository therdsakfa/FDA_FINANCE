Public Class Frm_Report_R4_004
    ...
    Public Function getReportData()
        ...
        Dim dt As DataTable = bao.getReportData_R4_004(rdp_dateReportSelect.SelectedDate)
    ...
    Private Sub btn_ShowReport_Click(sender As Object, e As EventArgs) Handles btn_ShowReport.Click
        ...
        util.ShowReport(ReportViewer1, util.root & "Module04\Report_R4_004.rdlc", "Fields_Report_R4_004", getReportData())
    End Sub
End Class