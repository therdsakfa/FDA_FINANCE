<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MAIN_NODE.Master" CodeBehind="Frm_SendMoneyDepartment.aspx.vb" Inherits="FDA_FINANCE.Frm_SendMoneyDepartment" %>
<%@ Register src="~/Module06/UserControl/UC_SendMoneyDepartments.ascx" tagname="UC_SendMoneyDepartments" tagprefix="uc1" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#ctl00_ContentPlaceHolder1_btnAdd').click(function () {
                ...
                openform("Frm_SendMoneyDepartment_Insert.aspx", "#if1"); //ใส่ url, ID iframe
                return false;
            });
        });
    ...
    <asp:Button ID="btnRedirect" runat="server" Text="Button" Style="display:none;" />
        ...
        <tr>
            <td>
                ...
                <uc1:UC_SendMoneyDepartments ID="UC_SendMoneyDepartments1" runat="server" />
