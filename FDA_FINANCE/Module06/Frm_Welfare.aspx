<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MAIN_NODE.Master" CodeBehind="Frm_Welfare.aspx.vb" Inherits="FDA_FINANCE.Frm_Welfare" %>
<%@ Register src="~/Module06/UserControl/UC_Welfares.ascx" tagname="UC_Welfares" tagprefix="uc1" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#ctl00_ContentPlaceHolder1_btnAdd').click(function () {
                ...
                openform("Frm_Welfare_Insert.aspx", "#if1"); //ใส่ url, ID iframe
                return false;
            });
        });
    ...
    <asp:Button ID="btnAdd" runat="server" Text="เพิ่มข้อมูล" />
        ...
        <tr>
            <td>
                ...
                <uc1:UC_Welfares ID="UC_Welfares1" runat="server" />
