<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Pre_Customer_Insert.aspx.vb" Inherits="FDA_FINANCE.Frm_Pre_Customer_Insert" %>
<%--<%@ Register src="~/Module06/UserControl/UC_CustomerDetails.ascx" tagname="UC_CustomerDetails" tagprefix="uc1" %>--%>
<%@ Register Src="~/Module06/UserControl/UC_Pre_CustomerDetails.ascx" TagName="UC_Pre_CustomerDetails" TagPrefix="uc1" %>
    ...
    <script src="../../Scripts/jdropdown/jquery.searchabledropdown-1.0.7.min.js"></script>
     <script type="text/javascript">
         $(document).ready(function () {
             ...
             //showdate($("#ctl00_ContentPlaceHolder1_UC_CustomerDetails1_txt_dateCer"));
             //showdate($("#ctl00_ContentPlaceHolder1_UC_CustomerDetails1_txt_dateCerEnd"));
...
<table>
        ...
        <tr>
            <td>
                <uc1:UC_Pre_CustomerDetails ID="UC_Pre_CustomerDetails1" runat="server" />
