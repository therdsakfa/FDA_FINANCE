<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Department.aspx.vb" Inherits="FDA_FINANCE.Frm_Department" %>
    ...
    <script type="text/javascript" >
        $(document).ready(function () {
            ...
            $('#ctl00_ContentPlaceHolder1_lbt_new_bg').click(function () {
                Popups('Frm_Department_Insert.aspx?typeid=1');
                return false;
            });
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#ctl00_ContentPlaceHolder1_lbt_new_bg').click(function () {
                ...
                openform("Frm_Department_Insert.aspx?typeid=1", "#if1"); //ใส่ url, ID iframe
                return false;
            });
        });
        //เพิ่มโหนดลูกๆ
    ...
    <div class="panel panel-body"  style="width:100%;">
        <table width="100%">
            <tr><td>
                ...
                <asp:LinkButton ID="lbt_new_bg" runat="server">เพิ่มหน่วยงาน</asp:LinkButton>
                </td>
            </tr>
            <tr><td>
