<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master.Master" CodeBehind="Frm_Margin_Receive.aspx.vb" Inherits="FDA_FINANCE.Frm_Margin_Receive" %>
<%@ Register src="UserControl/UC_Margin.ascx" tagname="UC_Margin" tagprefix="uc1" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#ctl00_ContentPlaceHolder1_btnAdd').click(function () {
                ...
                openform("Frm_Margin_Receive_Insert.aspx", "#if1"); //ใส่ url, ID iframe
                return false;
            });
        });
    ...
    <asp:Button ID="btnAdd" runat="server" Text="เพิ่มข้อมูล" />
        ...
        <tr>
            <td>
                ...
                <uc1:UC_Margin ID="UC_Margin1" runat="server" />
