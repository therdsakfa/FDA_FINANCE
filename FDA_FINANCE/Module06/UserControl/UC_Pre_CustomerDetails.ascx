<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UC_Pre_CustomerDetails.ascx.vb" Inherits="FDA_FINANCE.UC_Pre_CustomerDetails" %>
...
<td colspan = "4">
    ...
    <td>
       ...
       <%-- <asp:RadioButtonList ID="rd_Customertype" runat="server" >
        ...
        <td align="right" >
            <asp:Label ID="lb_person" runat="server"></asp:Label>
        </td>
        <td class="style1">
            ...
            &nbsp;<%--<asp:Button ID="getSW" runat="server" Text="เรียกข้อมูลIDEM" />--%><asp:Button ID="getSW_2" runat="server" Text="เรียกข้อมูลส่วนกลาง"/>
        
        </td>
    </tr>
    <tr>
    
     <td align="right" class="auto-style1">ชื่อเจ้าหนี้ : </td>
        <td class="auto-style1"><asp:TextBox ID="txt_CUSTOMER_NAME" runat="server"  Width="250px" ></asp:TextBox></td>
        <td align="right" class="auto-style1">ประเภทเจ้าหน้าที่ :</td>
