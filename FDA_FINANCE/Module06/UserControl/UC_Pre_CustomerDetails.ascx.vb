Public Class UC_Pre_CustomerDetails
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        lb_person.Text = "เลขประจำตัวผู้เสียภาษี"
    ...
    Protected Sub getSW_2_Click(sender As Object, e As EventArgs) Handles getSW_2.Click
        ...
        Dim dao_prefix As New DAO_MAS.TB_MAS_PREFIX_v2
        Dim dao As New DAO_MAS.TB_MAS_CUSTOMER
        Try
            dao_prefix.Getdata_by_ID_PREFIX(dao.fields.prefixcd)

            a.SYSLCNSNMs.prefixcd = dao_prefix.fields.PREFIX_NAME
        Catch ex As Exception
            a.SYSLCNSNMs.prefixcd = Nothing
        End Try

        If name = "" Then
            Response.Alert("ไม่มีข้อมูลในระบบ")
        Else
            txt_CUSTOMER_NAME.Text = a.SYSLCNSNMs.prefixcd & a.SYSLCNSNMs.thanm & " " & a.SYSLCNSNMs.thalnm
    ...
    Protected Sub ddCustomerType_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ddCustomerType.SelectedIndexChanged
        ...
        ElseIf ddCustomerType.SelectedItem.Value = "2" Then
            getSW_2.Visible = True
            lb_person.Text = "เลขประจำตัวประชาชน"
            ...
            txt_FAX.Text = ""
            ''''''''''''''''''''''''''''''''''''''
        ElseIf ddCustomerType.SelectedItem.Value = "7" Then
    ...
    Protected Sub btn_save_Click(sender As Object, e As EventArgs) Handles btn_save.Click
        ...
        'Else
        If txt_personal_edit_v2.Text = "" Then
            Response.Alert("กรุณาใส่เลขบัตรประชาชน")
        ...
        Else
            ...
            log.insert_log(NameUserAD(), System.IO.Path.GetFileName(Request.Path), _
                           Request.Url.AbsoluteUri.ToString(), "บันทึกข้อมูลเจ้าหนี้/ลูกหนี้ชื่อ " & dao.fields.CUSTOMER_NAME, "MAS_CUSTOMER", dao.fields.CUSTOMER_ID)
