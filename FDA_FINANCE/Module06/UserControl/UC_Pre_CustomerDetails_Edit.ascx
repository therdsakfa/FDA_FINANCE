<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UC_Pre_CustomerDetails_Edit.ascx.vb" Inherits="FDA_FINANCE.UC_Pre_CustomerDetails_Edit" %>
<style type="text/css">
    .style1
    {
        height: 26px;
...
<td colspan = "4">
    ...
    <tr>
        <td colspan="4">
            <asp:Panel ID="Panel3" runat="server" GroupingText="ข้อมูลเลขที่สัญญา">
                <table>
                <tr>
            <td align="right">เลขที่สัญญาจ้าง :</td>
            <td>
