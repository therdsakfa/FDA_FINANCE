<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_PayList.aspx.vb" Inherits="FDA_FINANCE.Frm_PayList" %>
<%@ Register src="~/Module06/UserControl/UC_PayLists.ascx" tagname="UC_PayLists" tagprefix="uc1" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#ctl00_ContentPlaceHolder1_btnAdd').click(function () {
                ...
                openform("Frm_PayList_Insert.aspx", "#if1"); //ใส่ url, ID iframe
                return false;
            });
        });
...
<td align="right">
    ...
    <asp:Button ID="btnRedirect" runat="server" Text="Button" Style="display:none;" />
        ...
        <tr>
            <td>
                <uc1:UC_PayLists ID="UC_PayLists1" runat="server" />
               </td>
        </tr>
    </table>
