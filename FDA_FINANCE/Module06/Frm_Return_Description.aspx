<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Return_Description.aspx.vb" Inherits="FDA_FINANCE.Frm_Return_Description" %>
<%@ Register src="UserControl/UC_Return_Description.ascx" tagname="UC_Return_Description" tagprefix="uc1" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#ctl00_ContentPlaceHolder1_btnAdd').click(function () {
                ...
                openform("Frm_Return_Description_Insert.aspx", "#if1"); //ใส่ url, ID iframe
                return false;
            });
        });
...
<td align="right">
    ...
    <asp:Button ID="btnRedirect" runat="server" Text="Button" Style="display:none;" />
        ...
        <tr>
            <td>
                <uc1:UC_Return_Description ID="UC_Return_Description1" runat="server" />
               </td>
        </tr>
    </table>
