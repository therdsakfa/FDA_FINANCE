<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_SendMoneyDepartment_Insert.aspx.vb" Inherits="FDA_FINANCE.Frm_SendMoneyDepartment_Insert" %>
...
<table>
        <tr>
            <td>บันทึกหน่วยงานที่นำส่งเงิน</td>
        </tr>
