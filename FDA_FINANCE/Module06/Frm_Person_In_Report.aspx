<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Person_In_Report.aspx.vb" Inherits="FDA_FINANCE.Frm_Person_In_Report" %>
<%@ Register src="UserControl/UC_Person_In_Report.ascx" tagname="UC_Person_In_Report" tagprefix="uc1" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#ctl00_ContentPlaceHolder1_btnAdd').click(function () {
                ...
                openform("Frm_Person_In_Report_Insert.aspx", "#if1"); //ใส่ url, ID iframe
                return false;
            });
        });
...
<tr>
<td>
    รายการผู้ตรวจสอบในรายงานทะเบียนคุมเช็ค
</td>
</tr>
<tr>
<td align="right">
    ...
    <asp:Button ID="btnRedirect" runat="server" Text="Button" Style="display:none;" />
        ...
        <tr>
            <td>
                ...
                <uc1:UC_Person_In_Report ID="UC_Person_In_Report1" runat="server" />
