<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Checker.aspx.vb" Inherits="FDA_FINANCE.Frm_Checker" %>
...
<td align="right">
    <asp:Button ID="btnAdd" runat="server" Text="เพิ่มข้อมูล" CssClass="btn-lg" />
        ...
        <tr>
            ...
            <telerik:RadGrid ID="rg_checker" runat="server"  AutoGenerateColumns="false" 
 Width="100%">
</telerik:RadGrid>
