<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_CustomerType.aspx.vb" Inherits="FDA_FINANCE.Frm_CustomerType" %>
<%@ Register src="~/Module06/UserControl/UC_CustomerType.ascx" tagname="UC_CustomerType" tagprefix="uc1" %>
    ...
    <script type="text/javascript" >
        $(document).ready(function () {
            ...
            $('#ctl00_ContentPlaceHolder1_btnAdd').click(function () {
                Popups('Frm_CustomerType_Insert.aspx');
                return false;
            });
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#ctl00_ContentPlaceHolder1_btnAdd').click(function () {
                ...
                openform("Frm_CustomerType_Insert.aspx", "#if1"); //ใส่ url, ID iframe
                return false;
            });
        });
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="panel panel-body"  style="width:100%;">
                <h3><font color="black">ประเภทเจ้าหนี้</font></h3>
...
<td align="right">
    <asp:Button ID="btnAdd" runat="server" Text="เพิ่มข้อมูล" CssClass="btn-lg" />
        ...
        <tr>
            <td>
                <uc1:UC_CustomerType ID="UC_CustomerType1" runat="server" />
                </td>
        </tr>
    </table>
    </div>
