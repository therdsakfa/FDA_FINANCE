Public Class Default_HRD
    ...
    Private Sub RunQuery()
        'Dim token As String = Request.QueryString("tokenHRD")
        '_TOKEN = Request("tokenHRD").ToString()
        '_TOKEN = Request.QueryString("tokenHRD")
        _bgyear = Master.get_Year()
        _deptId = Request.QueryString("DepartmentID2")
        _ProId = Request.QueryString("ProjectID")
    ...
    Sub token()
        ...
        Try
            ...
            If _deptId <> "" Then
                str_code = CStr(_deptId).Replace(vbCr, "").Replace(vbLf, "")
            Else
        ...
        If dt.Rows.Count > 0 Then
            ...
            If code = "900" Then
                Response.Redirect("HOME/FRM_PROJECT_SELECT_HRD.aspx?dept=" & dao_dept.fields.DEPARTMENT_ID & "&ProId=" & _ProId)
                'Response.Redirect("../Module02/Disburse_Budget/Frm_Disburse_Relate_Overview.aspx?bgid=" & 0 & "&dept=" & dao_dept.fields.DEPARTMENT_ID & "&myear=" & _bgyear)
