<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Import_Salary_Office.aspx.vb" Inherits="FDA_FINANCE.Frm_Import_Salary_Office" %>

<%@ Register Src="~/Module07/UC/UC_Import_Salary_Office.ascx" TagPrefix="uc1" TagName="UC_Import_Salary_Office" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <table>
        ...
        <tr>
            <td>
                <uc1:UC_Import_Salary_Office runat="server" id="UC_Import_Salary_Office1" />
            </td>
        </tr>
    </table>
</asp:Content>