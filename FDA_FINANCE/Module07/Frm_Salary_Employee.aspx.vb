Public Class Frm_Salary_Employee
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            End If
        End If
        UC_Salary_Employee1.BudgetYear = Request.QueryString("myear")
        UC_Salary_Employee1.month_num = dd_month.SelectedValue()
        UC_Salary_Employee1.per_type = 4
    End Sub
    Private Sub btnRedirect_Click(sender As Object, e As EventArgs) Handles btnRedirect.Click
        UC_Salary_Employee1.rg_rebind()
    End Sub
    ...
    Private Sub btnSearch_Click(sender As Object, e As EventArgs) Handles btnSearch.Click
        ...
        UC_Salary_Employee1.rgFilter(str)
    End Sub

    Private Sub btn_export_Click(sender As Object, e As EventArgs) Handles btn_export.Click
        UC_Salary_Employee1.export()
