<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Import_Salary_EMP.aspx.vb" Inherits="FDA_FINANCE.Frm_Import_Salary_EMP" %>

<%@ Register src="UC/UC_Import_Salary_Employee.ascx" tagname="UC_Import_Salary_Employee" tagprefix="uc1" %>
     ...
     <table>
        ...
        <tr>
            <td>
                ...
                <uc1:UC_Import_Salary_Employee ID="UC_Import_Salary_Employee1" runat="server" />
