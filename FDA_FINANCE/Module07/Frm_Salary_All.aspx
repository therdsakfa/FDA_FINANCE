<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main_Node.Master" CodeBehind="Frm_Salary_All.aspx.vb" Inherits="FDA_FINANCE.Frm_Salary_All" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#ctl00_ContentPlaceHolder1_btn_Add').click(function () {
                ...
                Popups('Frm_Salary_Personal_Insert.aspx?bgid=' + bgid.toString() + '&bgYear=' + bgYear.toString() + '&dept=' + select_dept.toString() + '&t=2');
                return false;
            });
            $('#ctl00_ContentPlaceHolder1_btn_copy').click(function () {

                var bgYear = getQuerystring('myear');
                Popups4('Frm_Import_Salary.aspx?bgYear=' + bgYear.toString());
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="panel panel-body" style="width: 100%;">
        <h3>รายการจ่ายค่าตอบแทนพนักงานราชการ</h3>
    </div>
    <div class="panel panel-body" style="width: 100%;">
    ...
    <div class="panel panel-body" style="width: 100%;">
        <table width="100%">
            <tr>
                <td>&nbsp;</td>
                <td align="right" valign="middle">เดือน &nbsp;<asp:DropDownList ID="dd_month" runat="server" AutoPostBack="true" Height="30px" Width="15%">
            ...
            <tr>
                <td colspan="2">
                    ...
                    <uc1:UC_Salary_ALL ID="UC_Salary_ALL1" runat="server" />
        ...
        <div class="panel panel-info" style="width: 100%">
            <div class="panel-heading">
                <div class="modal-title text-center h1 ">
                    บันทึกพนักงานราชการผู้รับเงินเดือน
    ...
    <div class="modal fade" id="myModal2">
        <div class="panel panel-info" style="width: 100%">
            <div class="panel-heading">
                <div class="modal-title text-center h1 ">
                    แก้ไขพนักงานราชการผู้รับเงินเดือน
                    <button type="button" class="btn btn-default pull-right" data-dismiss="modal" onclick="refresh()">ปิดหน้าต่าง</button>
                </div>
                <div class="panel-body panel-info" style="width: 100%">
