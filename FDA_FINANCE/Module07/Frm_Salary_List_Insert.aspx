<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BG_Master2.Master" CodeBehind="Frm_Salary_List_Insert.aspx.vb" Inherits="FDA_FINANCE.Frm_Salary_List_Insert" %>
<%@ Register src="UC/UC_Salary_List_Detail.ascx" tagname="UC_Salary_List_Detail" tagprefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
            <td>
                ...
                <uc1:UC_Salary_List_Detail ID="UC_Salary_List_Detail1" runat="server" />
        ...
        <tr>
        <td>
        <asp:Button ID="btn_bill_save" runat="server" Text="บันทึก" Width="70px" />
        </td>
