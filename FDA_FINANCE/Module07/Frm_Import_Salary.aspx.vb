Public Class Frm_Import_Salary
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If dd_month.Items.Count = 0 Then
            dd_month.DataBind()
        End If
        UC_Import_Salary1.month_nm = dd_month.SelectedValue
        If Not IsPostBack Then
            set_dd_bgyear(dd_BudgetYear)
        End If
        ' UC_Welfare_Cremation_Import1.BudgetYear = Request.QueryString("bgYear")
        UC_Import_Salary1.BudgetYear = dd_BudgetYear.SelectedValue
        UC_Import_Salary1.byear_query = Request.QueryString("bgYear")
    End Sub
    Private Sub btn_Save_Click(sender As Object, e As EventArgs) Handles btn_Save.Click
        If dd_month_dis.SelectedValue <> "" Then
            UC_Import_Salary1.insert(dd_month_dis.SelectedValue)
